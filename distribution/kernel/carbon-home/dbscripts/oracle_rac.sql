...
SELECT 'root4a8d-113f-4211-a0d5-efe36b082211', 'ROOT', 'This is the root organization.', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'ACTIVE', 'TENANT' FROM DUAL
WHERE NOT EXISTS (SELECT * FROM UM_ORG WHERE UM_ID = 'root4a8d-113f-4211-a0d5-efe36b082211')
/
...
/
CREATE TABLE UM_ORG_GROUP(
            UM_GROUP_ID VARCHAR(255) NOT NULL,
            UM_GROUP_NAME VARCHAR(255) NOT NULL,
            UM_TENANT_ID INTEGER DEFAULT 0,
            PRIMARY KEY(UM_GROUP_ID)
)
/
...
CREATE TABLE UM_ORG_ROLE_GROUP(
            ...
            CONSTRAINT FK_UM_ORG_ROLE_GROUP_UM_ORG_GROUP FOREIGN KEY (UM_GROUP_ID) REFERENCES UM_ORG_GROUP(UM_GROUP_ID) ON DELETE CASCADE
)
/
...
SELECT 'root4a8d-113f-4211-a0d5-efe36b082211', 'root4a8d-113f-4211-a0d5-efe36b082211', 0 FROM DUAL
WHERE NOT EXISTS (SELECT * FROM UM_ORG_HIERARCHY WHERE UM_PARENT_ID = 'root4a8d-113f-4211-a0d5-efe36b082211' AND UM_ID = 'root4a8d-113f-4211-a0d5-efe36b082211')
/
