...
CREATE SEQUENCE UM_ORG_GOVERNANCE_POLICY_SEQ  START WITH 1  INCREMENT BY 1 CACHE 20
/

CREATE OR REPLACE TRIGGER UM_ORG_GOVERNANCE_POLICY_TRIGGER
        BEFORE INSERT
        ON UM_ORG_GOVERNANCE_POLICY
        REFERENCING NEW AS NEW
        FOR EACH ROW
            BEGIN
                SELECT UM_ORG_GOVERNANCE_POLICY_SEQ.nextval INTO :NEW.UM_ID FROM dual;
            END;
/

CREATE TABLE UM_ORG_GOVERNANCE_ORG_SELECTED (
    UM_ID INTEGER NOT NULL,
    UM_POLICY_ID INTEGER NOT NULL,
    UM_TARGET_ORG_ID VARCHAR(36) NOT NULL,
    PRIMARY KEY (UM_ID),
...
CREATE SEQUENCE UM_ORG_GOVERNANCE_ORG_SELECTED_SEQ  START WITH 1  INCREMENT BY 1 CACHE 20
/

CREATE OR REPLACE TRIGGER UM_ORG_GOVERNANCE_ORG_SELECTED_TRIGGER
        BEFORE INSERT
        ON UM_ORG_GOVERNANCE_ORG_SELECTED
        REFERENCING NEW AS NEW
        FOR EACH ROW
            BEGIN
                SELECT UM_ORG_GOVERNANCE_ORG_SELECTED_SEQ.nextval INTO :NEW.UM_ID FROM dual;
            END;
/
