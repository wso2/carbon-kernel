...
CREATE TABLE UM_HYBRID_USER_ROLE(
            ...
            UM_TENANT_ID INTEGER DEFAULT 0,
            UM_DOMAIN_ID INTEGER,
            UM_EDIT_RESTRICTION VARCHAR(255) NOT NULL DEFAULT 'Not Restricted',
...
CREATE TABLE UM_ORG_USER_ASSOCIATION(
    ...
    UM_EDIT_RESTRICTION VARCHAR(255) DEFAULT 'Not Restricted' NOT NULL,
...
CREATE TABLE UM_SHARED_USER_RESTRICTED_EDIT_PERMISSIONS (
    UM_ID INTEGER NOT NULL,
    UM_USER_ASSOCIATION_ID INTEGER NOT NULL,
    UM_EDIT_OPERATION VARCHAR(255) NOT NULL,
    UM_PERMITTED_ORG_ID VARCHAR(36) NOT NULL,
    PRIMARY KEY (UM_ID),
    CONSTRAINT FK_USER_ASSOCIATION FOREIGN KEY (UM_USER_ASSOCIATION_ID)
        REFERENCES UM_ORG_USER_ASSOCIATION (UM_ID)
        ON DELETE CASCADE
)
/

CREATE SEQUENCE UM_SHARED_USER_RESTRICTED_EDIT_PERMISSIONS_SEQ  START WITH 1  INCREMENT BY 1  CACHE 20
/

CREATE OR REPLACE TRIGGER UM_SHARED_USER_RESTRICTED_EDIT_PERMISSIONS_TRIGGER
        BEFORE INSERT
        ON UM_SHARED_USER_RESTRICTED_EDIT_PERMISSIONS
        REFERENCING NEW AS NEW
        FOR EACH ROW
            BEGIN
                SELECT UM_SHARED_USER_RESTRICTED_EDIT_PERMISSIONS_SEQ.nextval INTO :NEW.UM_ID FROM dual;
            END;
/
...
CREATE TABLE UM_RESOURCE_SHARING_POLICY (
    ...
    UM_INITIATING_ORG_ID INTEGER NOT NULL,
    UM_POLICY_HOLDING_ORG_ID INTEGER NOT NULL,
