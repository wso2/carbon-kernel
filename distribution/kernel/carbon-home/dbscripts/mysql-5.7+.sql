...
CREATE INDEX REG_LOG_IND_BY_REG_LOGGED_TIME USING HASH ON REG_LOG(REG_LOGGED_TIME, REG_TENANT_ID);
...
CREATE INDEX REG_RESOURCE_IND_BY_TENANT_UUID USING HASH ON REG_RESOURCE(REG_TENANT_ID, REG_UUID);
