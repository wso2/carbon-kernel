...
CREATE INDEX IF NOT EXISTS REG_LOG_IND_BY_REG_LOGGED_TIME ON REG_LOG(REG_LOGGED_TIME, REG_TENANT_ID);
...
CREATE INDEX IF NOT EXISTS REG_RESOURCE_IND_BY_TENANT_UUID ON REG_RESOURCE(REG_TENANT_ID, REG_UUID);
