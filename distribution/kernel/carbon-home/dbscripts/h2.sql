...
REG_RESOURCE_IND_BY_NAME ON REG_RESOURCE(REG_NAME, REG_TENANT_ID);
REG_RESOURCE_IND_BY_PATH_ID_NAME ON REG_RESOURCE(REG_PATH_ID, REG_NAME, REG_TENANT_ID);
REG_RESOURCE_IND_BY_UUID ON REG_RESOURCE(REG_UUID);
...
CREATE TABLE IF NOT EXISTS UM_ORG_GOVERNANCE_POLICY (
            UM_ID INTEGER NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS UM_ORG_GOVERNANCE_POLICY_SELECTED_ORGS (
            UM_ID INTEGER NOT NULL AUTO_INCREMENT,
...
CREATE INDEX IF NOT EXISTS  IDX_ORG_GOV_SEL_ORG ON UM_ORG_GOVERNANCE_POLICY_SELECTED_ORGS (UM_SELECTED_ORG_ID);
