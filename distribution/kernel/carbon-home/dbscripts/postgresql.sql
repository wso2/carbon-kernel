...
CREATE TABLE UM_HYBRID_USER_ROLE_RESTRICTED_EDIT_PERMISSIONS (
            ...
            FOREIGN KEY (UM_HYBRID_USER_ROLE_ID, UM_HYBRID_USER_ROLE_TENANT_ID)
                REFERENCES UM_HYBRID_USER_ROLE(UM_ID, UM_TENANT_ID) ON DELETE CASCADE ON UPDATE RESTRICT
);
...
DROP TABLE IF EXISTS UM_SHARED_USER_RESTRICTED_EDIT_PERMISSIONS;
DROP SEQUENCE IF EXISTS UM_SHARED_USER_RESTRICTED_EDIT_PERMISSIONS_PK_SEQ;
CREATE SEQUENCE UM_SHARED_USER_RESTRICTED_EDIT_PERMISSIONS_PK_SEQ;
CREATE TABLE UM_SHARED_USER_RESTRICTED_EDIT_PERMISSIONS (
    UM_ID INTEGER DEFAULT NEXTVAL('UM_SHARED_USER_RESTRICTED_EDIT_PERMISSIONS_PK_SEQ'),
    UM_USER_ASSOCIATION_ID INTEGER NOT NULL,
    UM_EDIT_OPERATION VARCHAR(255) NOT NULL,
    UM_PERMITTED_ORG_ID VARCHAR(36) NOT NULL,
    PRIMARY KEY (UM_ID),
    FOREIGN KEY (UM_USER_ASSOCIATION_ID) REFERENCES UM_ORG_USER_ASSOCIATION (UM_ID) ON DELETE CASCADE
);
