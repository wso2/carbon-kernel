...
CREATE SEQUENCE IF NOT EXISTS UM_ORG_GOVERNANCE_POLICY_PK_SEQ;
CREATE TABLE IF NOT EXISTS UM_ORG_GOVERNANCE_POLICY (
    UM_ID INTEGER DEFAULT NEXTVAL('UM_ORG_GOVERNANCE_POLICY_PK_SEQ'),
...
CREATE SEQUENCE IF NOT EXISTS UM_ORG_GOVERNANCE_ORG_SELECTED_PK_SEQ;
CREATE TABLE IF NOT EXISTS UM_ORG_GOVERNANCE_ORG_SELECTED (
    UM_ID INTEGER DEFAULT NEXTVAL('UM_ORG_GOVERNANCE_ORG_SELECTED_PK_SEQ'),
