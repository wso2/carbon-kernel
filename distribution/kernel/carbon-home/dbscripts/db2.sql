...
CREATE TABLE UM_TENANT(
    ...
    PRIMARY KEY(UM_ID),
    CONSTRAINT INDEX_UM_TENANT_UM_DOMAIN_NAME UNIQUE(UM_DOMAIN_NAME),
...
CREATE TABLE UM_USER(
    ...
    UNIQUE(UM_USER_ID),
    CONSTRAINT INDEX_UM_USERNAME_UM_TENANT_ID UNIQUE(UM_USER_NAME, UM_TENANT_ID)
)/
...
CREATE TABLE UM_PERMISSION(
    ...
    CONSTRAINT INDEX_UM_PERMISSION_UM_RESOURCE_ID_UM_ACTION UNIQUE(UM_RESOURCE_ID, UM_ACTION, UM_TENANT_ID),
    PRIMARY KEY(UM_ID,UM_TENANT_ID)
)/
