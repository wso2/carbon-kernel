...
CREATE SEQUENCE UM_ORG_GOVERNANCE_POLICY_SEQ AS DECIMAL(27,0)
    INCREMENT BY 1
    START WITH 1
    NO CACHE/

CREATE TRIGGER UM_ORG_GOVERNANCE_POLICY_TRG NO CASCADE BEFORE INSERT ON UM_ORG_GOVERNANCE_POLICY
REFERENCING NEW AS NEW FOR EACH ROW MODE DB2SQL
BEGIN ATOMIC
    SET (NEW.UM_ID)
        = (NEXTVAL FOR UM_ORG_GOVERNANCE_POLICY_SEQ);END/

CREATE TABLE IF NOT EXISTS UM_ORG_GOVERNANCE_ORG_SELECTED (
    UM_ID DECIMAL(31,0) NOT NULL,
    UM_POLICY_ID DECIMAL(31,0) NOT NULL,
...
CREATE SEQUENCE UM_ORG_GOVERNANCE_ORG_SELECTED_SEQ AS DECIMAL(27,0)
    INCREMENT BY 1
    START WITH 1
    NO CACHE/

CREATE TRIGGER UM_ORG_GOVERNANCE_ORG_SELECTED_TRG NO CASCADE BEFORE INSERT ON UM_ORG_GOVERNANCE_ORG_SELECTED
REFERENCING NEW AS NEW FOR EACH ROW MODE DB2SQL
BEGIN ATOMIC
    SET (NEW.UM_ID)
        = (NEXTVAL FOR UM_ORG_GOVERNANCE_ORG_SELECTED_SEQ);END/
