...
SELECT 'root4a8d-113f-4211-a0d5-efe36b082211', 'ROOT', 'This is the root organization.', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'ACTIVE', 'TENANT' FROM "SYSIBM".SYSDUMMY1
...
CREATE TABLE IF NOT EXISTS UM_ORG_GROUP(
            UM_GROUP_ID VARCHAR(255) NOT NULL,
            UM_GROUP_NAME VARCHAR(255) NOT NULL,
            UM_TENANT_ID INTEGER DEFAULT 0,
...
SELECT 'root4a8d-113f-4211-a0d5-efe36b082211', 'root4a8d-113f-4211-a0d5-efe36b082211', 0 FROM "SYSIBM".SYSDUMMY1
