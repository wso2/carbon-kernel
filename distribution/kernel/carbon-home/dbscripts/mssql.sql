...
IF NOT EXISTS (SELECT * FROM UM_ORG WHERE UM_ID = 'root4a8d-113f-4211-a0d5-efe36b082211')
BEGIN
...
IF NOT  EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[UM_ORG_GROUP]') AND TYPE IN (N'U'))
...
IF NOT EXISTS (SELECT * FROM UM_ORG_HIERARCHY WHERE UM_PARENT_ID = 'root4a8d-113f-4211-a0d5-efe36b082211' AND UM_ID = 'root4a8d-113f-4211-a0d5-efe36b082211')
BEGIN
