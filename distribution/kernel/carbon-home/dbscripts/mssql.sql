...
IF EXISTS (SELECT NAME FROM SYSINDEXES WHERE NAME = 'REG_LOG_IND_BY_REG_LOGGED_TIME')
DROP INDEX REG_LOG.REG_LOG_IND_BY_REG_LOGGED_TIME
...
IF EXISTS (SELECT NAME FROM SYSINDEXES WHERE NAME = 'REG_RESOURCE_IND_BY_TENANT_UUID')
DROP INDEX REG_RESOURCE.REG_RESOURCE_IND_BY_TENANT_UUID
CREATE INDEX REG_RESOURCE_IND_BY_TENANT_UUID ON REG_RESOURCE(REG_TENANT_ID, REG_UUID);
