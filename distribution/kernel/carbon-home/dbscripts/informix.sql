...
CREATE TABLE IF NOT EXISTS UM_SHARED_USER_RESTRICTED_EDIT_PERMISSIONS (
            UM_ID INTEGER NOT NULL AUTO_INCREMENT,
            ...
            FOREIGN KEY (UM_USER_ASSOCIATION_ID)
                REFERENCES UM_ORG_USER_ASSOCIATION(UM_ID) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE IF NOT EXISTS UM_SHARED_RESOURCE_ATTRIBUTES (
            ...
            FOREIGN KEY (UM_RESOURCE_SHARING_POLICY_ID)
                REFERENCES UM_RESOURCE_SHARING_POLICY(UM_ID) ON DELETE CASCADE ON UPDATE CASCADE
);
