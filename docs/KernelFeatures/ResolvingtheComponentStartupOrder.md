...
> The core capabilities that are available at Carbon Kernel-level are listed below. For the full list of capabilities available in Carbon Kernel 5.1.0, see the [root README.md file](master/core/README.md). 
