# Getting Started
> The process of setting up and starting WSO2 Carbon server is explained below. For the full list of capabilities available in kernel version, see the **features** section in the [root README.md file](../README.md#key-features-and-tools). 
