...
public interface Cache<K, V> extends Iterable<Cache.Entry<K, V>>, CacheLifecycle {
     ...
     * <h1>Effects:</h1>
     * <ul>
     * <li>Expiry - updates {@link javax.cache.CacheConfiguration.ExpiryType#ACCESSED Access Time}.</li>
     ...
     * <ul>
     * <li>Statistics must be mutable when status is {@link Status#STARTED} ({@link javax.cache.CacheConfiguration#setStatisticsEnabled(boolean)})</li>
     * </ul>
     * <p/>
     ...
     * V if {@link javax.cache.Cache.MutableEntry#getKey()} or {@link javax.cache.Cache.MutableEntry#getValue()}
     * is invoked.
     *
     * @param <K> the type of keys maintained by this cache
     * @param <V> the type of cached values
    ...
    public interface EntryProcessor<K, V> {
         ...
         * @return the result
         */
        Object process(MutableEntry<K, V> entry);
    }
}
