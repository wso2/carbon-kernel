 ...
 * of application data.
 * <p>
 * Like {@link java.util.Map}s, {@link Cache}s
 * <ol>
 ...
 * </ol>
 * <p>
 * Unlike {@link java.util.Map}s, {@link Cache}s
 * <ol>
...
public interface Cache<K, V> extends Iterable<Cache.Entry<K, V>>, Closeable {
   ...
   * {@link java.util.Map} of the values associated with the set of keys requested.
   * <p>
   ...
   * {@link java.util.Set} in parallel.  Iteration however must not occur in parallel,
   * thus allow for non-thread-safe {@link java.util.Set}s to be used.
   * <p>
   ...
   *              {@link javax.cache.configuration.Configuration}.class and
   *              {@link javax.cache.configuration.CompleteConfiguration}s.
   * @return the requested implementation of {@link javax.cache.configuration.Configuration}
   ...
   * {@link java.util.Map} of {@link EntryProcessorResult}s, one result per key.  Should the
