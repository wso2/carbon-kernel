 ...
 * acquire an appropriate {@link javax.cache.spi.CachingProvider} implementation.
 * <p>
 ...
 * {@link javax.cache.spi.CachingProvider} implementation based on implementation specific
 * instructions.
 * <p>
 * When using the {@link Caching} class, {@link javax.cache.spi.CachingProvider} implementations
 * are automatically discovered when they follow the conventions outlined by the
 * Java Development Kit {@link java.util.ServiceLoader} class.
 * <p>
 ...
 * <p>
 * For a {@link javax.cache.spi.CachingProvider} to be automatically discoverable by the
 * {@link Caching} class, the fully qualified class name of the
 * {@link javax.cache.spi.CachingProvider} implementation must be declared in the following
 * file:
 * <pre>
 ...
 * {@link javax.cache.spi.CachingProvider} implementation is specified using the system property
 * <code>javax.cache.spi.cachingprovider</code>, that implementation will be used
 * as the default {@link javax.cache.spi.CachingProvider}.
 * <p>
 * All {@link javax.cache.spi.CachingProvider}s that are automatically detected or explicitly
 ...
 * {@link javax.cache.spi.CachingProvider} is requested, it will be simply returned from the
 ...
 * {@link javax.cache.spi.CachingProvider}s implementations, from the same or different
 ...
 * </ol>
 * To request a specific {@link javax.cache.spi.CachingProvider} implementation, a developer
 * should use either the {@link #getCachingProvider(String)} or
 * {@link #getCachingProvider(String, ClassLoader)} method.
 * <p>
 * Where multiple {@link javax.cache.spi.CachingProvider}s are present, the
 * {@link javax.cache.spi.CachingProvider} returned by getters {@link #getCachingProvider()} and
...
public final class Caching {
  ...
  /**
   * The {@link CachingProviderRegistry} that tracks the {@link javax.cache.spi.CachingProvider}s.
   */
  ...
  /**
   * Obtains the default {@link javax.cache.spi.CachingProvider} available via the
   * {@link #getDefaultClassLoader()}.
   *
   * @return the {@link javax.cache.spi.CachingProvider}
   * @throws CacheException    should zero, or more than one
   *                           {@link javax.cache.spi.CachingProvider} be available on the
  ...
  /**
   * Obtains the single {@link javax.cache.spi.CachingProvider} visible to the specified
   * {@link ClassLoader}.
   *
   * @param classLoader the {@link ClassLoader} to use for loading the
   *                    {@link javax.cache.spi.CachingProvider}
   * @return the {@link javax.cache.spi.CachingProvider}
   * @throws CacheException    should zero, or more than one
   *                           {@link javax.cache.spi.CachingProvider} be available on the
   *                           classpath, or it could not be loaded
  ...
  /**
   * Obtains the {@link javax.cache.spi.CachingProvider}s that are available via the
   * {@link #getDefaultClassLoader()}.
   * <p>
   * If a <code>javax.cache.spi.cachingprovider</code> system property is defined,
   * only that {@link javax.cache.spi.CachingProvider} specified by that property is returned.
   * Otherwise all {@link javax.cache.spi.CachingProvider}s that are available via a
   * {@link java.util.ServiceLoader} for {@link javax.cache.spi.CachingProvider}s using the default
   * {@link ClassLoader} (including those previously requested via
   * {@link #getCachingProvider(String)}) are returned.
   *
   * @return an {@link Iterable} of {@link javax.cache.spi.CachingProvider}s loaded by the
  ...
  /**
   * Obtains the {@link javax.cache.spi.CachingProvider}s that are available via the specified
   * {@link ClassLoader}.
   * <p>
   * If a <code>javax.cache.spi.cachingprovider</code> system property is defined,
   * only that {@link javax.cache.spi.CachingProvider} specified by that property is returned.
   * Otherwise all {@link javax.cache.spi.CachingProvider}s that are available via a
   * {@link java.util.ServiceLoader} for {@link javax.cache.spi.CachingProvider}s using the specified
   * {@link ClassLoader} (including those previously requested via
   * {@link #getCachingProvider(String, ClassLoader)}) are returned.
   *
   * @param classLoader the {@link ClassLoader} of the returned
   *                    {@link javax.cache.spi.CachingProvider}s
   * @return an {@link Iterable} of {@link javax.cache.spi.CachingProvider}s loaded by the
   *         specified {@link ClassLoader}
   */
  public static Iterable<CachingProvider> getCachingProviders(
  ...
  /**
   * Obtain the {@link javax.cache.spi.CachingProvider} that is implemented by the specified
   * fully qualified class name using the {@link #getDefaultClassLoader()}.
   * Should this {@link javax.cache.spi.CachingProvider} already be loaded it is simply returned,
   ...
   *                                {@link javax.cache.spi.CachingProvider}
   * @return the {@link javax.cache.spi.CachingProvider}
   * @throws CacheException    if the {@link javax.cache.spi.CachingProvider} cannot be created
   * @throws SecurityException when the operation could not be performed
   *                           due to the current security settings
   */
   ...
   * Should this {@link javax.cache.spi.CachingProvider} already be loaded it is returned,
   * otherwise an attempt will be made to load and instantiate the specified
   * class (using a no-args constructor).
   *
   * @param fullyQualifiedClassName the fully qualified class name of the
  ...
  /**
   * Maintains a registry of loaded {@link javax.cache.spi.CachingProvider}s scoped by
   * {@link ClassLoader}.
   */
  private static class CachingProviderRegistry {

    /**
     * The {@link javax.cache.spi.CachingProvider}s by Class Name organized by the
    ...
    /**
     * Obtains the only {@link javax.cache.spi.CachingProvider} defined by the
     * {@link #getDefaultClassLoader()}.
     * <p/>
     * Should zero or more than one {@link javax.cache.spi.CachingProvider}s be available, a
     * CacheException is thrown.
     *
     * @return the {@link javax.cache.spi.CachingProvider}
     * @throws CacheException should zero or more than one
     *                        {@link javax.cache.spi.CachingProvider} be available
     *                        or a {@link javax.cache.spi.CachingProvider} could not be loaded
    ...
    /**
     * Obtains the only {@link javax.cache.spi.CachingProvider} defined by the specified
     * {@link ClassLoader}.
     * <p/>
     * Should zero or more than one {@link javax.cache.spi.CachingProvider}s be available, a
     * CacheException is thrown.
    ...
    /**
     * Obtain the {@link javax.cache.spi.CachingProvider}s that are available via the
     * {@link #getDefaultClassLoader()}.
     * <p/>
     * If a <code>javax.cache.spi.cachingprovider</code> system property is defined,
     * only that {@link javax.cache.spi.CachingProvider} specified by that property is returned.
    ...
    /**
     * Obtain the {@link javax.cache.spi.CachingProvider}s that are available via the specified
     * {@link ClassLoader}.
     * <p/>
     * If a <code>javax.cache.spi.cachingprovider</code> system property is defined,
     * only that {@link javax.cache.spi.CachingProvider} specified by that property is returned.
     ...
     * Obtain the {@link javax.cache.spi.CachingProvider} that is implemented by the specified
     * fully qualified class name using the {@link #getDefaultClassLoader()}.
     * Should this {@link javax.cache.spi.CachingProvider} already be loaded it is simply
     ...
     *                                {@link javax.cache.spi.CachingProvider}
     * @return the {@link javax.cache.spi.CachingProvider}
     * @throws CacheException when the {@link javax.cache.spi.CachingProvider} can't be created
     */
    ...
    /**
     * Load and instantiate the {@link javax.cache.spi.CachingProvider} with the specified
     * fully qualified class name using the provided {@link ClassLoader}
     *
     * @param fullyQualifiedClassName the name of the {@link javax.cache.spi.CachingProvider}
     *                                class
     * @param classLoader             the {@link ClassLoader} to use
     * @return a new {@link javax.cache.spi.CachingProvider} instance
     * @throws CacheException if the specified {@link javax.cache.spi.CachingProvider} could not be
     *                        loaded
