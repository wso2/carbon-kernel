...
public class MutableConfiguration<K, V> implements CompleteConfiguration<K, V> {
   ...
   *
   * @param factory the {@link javax.cache.integration.CacheLoader} {@link Factory}
   * @return the {@link MutableConfiguration} to permit fluent-style method calls
   */
   ...
   *
   * @param factory the {@link javax.cache.integration.CacheWriter} {@link Factory}
   * @return the {@link MutableConfiguration} to permit fluent-style method calls
   */
  ...
  /**
   * Set the {@link Factory} for the {@link javax.cache.expiry.ExpiryPolicy}.  If <code>null</code>
   * is specified the default {@link javax.cache.expiry.ExpiryPolicy} is used.
   *
   * @param factory the {@link javax.cache.expiry.ExpiryPolicy} {@link Factory}
   * @return the {@link MutableConfiguration} to permit fluent-style method calls
   */
   ...
   * {@link javax.cache.integration.CacheLoader} {@link Factory}.
   *
   ...
   * <p>
   * It is an invalid configuration to set this to true without specifying a
   * {@link javax.cache.integration.CacheWriter} {@link Factory}.
   *
