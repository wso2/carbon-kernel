...
public final class CreatedExpiryPolicy implements ExpiryPolicy, Serializable {
  ...
  /**
   * Obtains a {@link javax.cache.configuration.Factory} for a Created {@link ExpiryPolicy}.
   *
   * @return a {@link javax.cache.configuration.Factory} for a Created {@link ExpiryPolicy}.
   */
