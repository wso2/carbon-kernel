...
public final class AccessedExpiryPolicy implements ExpiryPolicy, Serializable {
  ...
  /**
   * Obtains a {@link javax.cache.configuration.Factory} for an Accessed {@link ExpiryPolicy}.
   *
   * @return a {@link javax.cache.configuration.Factory} for an Accessed {@link ExpiryPolicy}.
   */
