 ...
 * {@link javax.cache.Cache#get(Object)} was called for the key.  This includes updating
 * necessary statistics, consulting the configured {@link javax.cache.expiry.ExpiryPolicy} and loading
 ...
 * javax.cache.Cache#put(Object, Object)} was called for the key. This includes updating
 * necessary statistics, consulting the configured {@link
 * javax.cache.expiry.ExpiryPolicy}, notifying {@link CacheEntryListener}s and writing to a
 * configured {@link CacheWriter}.
 * <p>
 * {@link javax.cache.Cache.Entry} removal, via a call to
 * {@link MutableEntry#remove()}, will behave as if {@link javax.cache.Cache#remove(Object)}
 ...
 * <li>{@link MutableEntry#setValue(Object)}</li>
 * </ol>
 * This will have the following {@link javax.cache.Cache} effects:
 * <br>
