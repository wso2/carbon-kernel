...
//		                        String serverURL = (String) request.getSession().getAttribute(CarbonConstants.SERVER_URL);
    ...
    <div style="background-color: #fff5e8;text-align: justify;padding: 10px;align-self: center;">
        Management Console is currently operating in legacy mode. It offers limited functionality, such as Multi-Tenancy, XACML, and Keystore Management. For a more comprehensive suite of features, we strongly recommend using the new console.
    </div>
    <%
    }
    %>
