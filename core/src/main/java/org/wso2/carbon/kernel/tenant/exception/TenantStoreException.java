 ...
 */
package org.wso2.carbon.kernel.tenant.exception;

/**
 * The exception class used by TenantStore implementation during any error situation while trying the save, load tenant
