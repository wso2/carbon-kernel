...
public class CarbonRollingFileAppender extends RollingFileAppender implements LoggingBridge {
    ...
    protected void subAppend(LoggingEvent loggingEvent) {
        ...
        AccessController.doPrivileged(new PrivilegedAction<Void>() {
            public Void run() {
                CarbonRollingFileAppender.super.subAppend(tenantAwareLoggingEvent);
