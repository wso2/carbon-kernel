...
public interface RegistryService {
     ...
     * @throws RegistryException if an error occurs
     */
    Registry getRegistry(String userName, String password) throws RegistryException;
     ...
     * @throws RegistryException if an error occurs
     */
    Registry getRegistry(String userName) throws RegistryException;
     ...
     * @throws RegistryException if an error occurs
     */
    Registry getRegistry(String userName, String password, int tenantId)
     ...
     * @throws RegistryException if an error occurs
     */
    Registry getRegistry(String userName, int tenantId) throws RegistryException;
     ...
     * @throws RegistryException if an error occurs
     */
    Registry getRegistry(String userName, int tenantId, String chroot) throws RegistryException;
     ...
     * @throws RegistryException if an error occurs
     */
    Registry getLocalRepository(int tenantId) throws RegistryException;
     ...
     * @throws RegistryException if an error occurs
     */
    Registry getConfigSystemRegistry(int tenantId) throws RegistryException;
     ...
     * @throws RegistryException if an error occurs
     */
    Registry getConfigUserRegistry(String userName, String password) throws RegistryException;
     ...
     * @throws RegistryException if an error occurs
     */
    Registry getConfigUserRegistry(String userName) throws RegistryException;
     ...
     * @throws RegistryException if an error occurs
     */
    Registry getConfigUserRegistry(String userName, int tenantId) throws RegistryException;
     ...
     * @throws RegistryException if an error occurs
     */
    Registry getConfigUserRegistry(String userName, String password, int tenantId)
            throws RegistryException;
     ...
     * @throws RegistryException if an error occurs
     */
    Registry getGovernanceSystemRegistry(int tenantId) throws RegistryException;
     ...
     * @throws RegistryException if an error occurs
     */
    Registry getGovernanceUserRegistry(String userName, String password)
            throws RegistryException;
     ...
     * @throws RegistryException if an error occurs
     */
    Registry getGovernanceUserRegistry(String userName) throws RegistryException;
     ...
     * @throws RegistryException if an error occurs
     */
    Registry getGovernanceUserRegistry(String userName, String password, int tenantId)
            throws RegistryException;
     ...
     * @throws RegistryException if an error occurs
     */
    Registry getGovernanceUserRegistry(String userName, int tenantId) throws RegistryException;
}