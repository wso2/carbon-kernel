...
public class BundleInfoLine {
    ...
    public BundleInfoLine(String bundleSymbolicName, String bundleVersion,
                          String bundlePath, int startLevel, boolean isFragment) {
    ...
    public static BundleInfoLine getInstance(String bundleInfoLineStr) throws Exception {
        ...
        return new BundleInfoLine(parts[0].trim(), parts[1].trim(), parts[2].trim(),
                Integer.parseInt(parts[3].trim()), !Boolean.parseBoolean(parts[4].trim()));
    }
