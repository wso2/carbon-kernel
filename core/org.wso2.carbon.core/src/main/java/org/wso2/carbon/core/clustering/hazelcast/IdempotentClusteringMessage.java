 ...
 */
public class IdempotentClusteringMessage<T extends ClusteringMessage> extends ClusteringMessage {

    private static final transient Log log = LogFactory.getLog(IdempotentClusteringMessage.class);
    private static final long serialVersionUID = 95L;
    private T wrappedMessage;
    private String clusterNodeId;

    public IdempotentClusteringMessage(T wrappedMessage) {
