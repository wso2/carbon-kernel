 ...
 */
public class KeyStoreRegistryPersistenceManager implements KeyStorePersistenceManager {

    private static final Log LOG = LogFactory.getLog(KeyStoreRegistryPersistenceManager.class);
