...
public class DefaultRealm implements UserRealm {
    ...
    private Map<String, RealmConfiguration> lazyUserStoreLoader = new HashMap<>();
    ...
    public void addSecondaryUserStoreManager(RealmConfiguration userStoreRealmConfig) throws UserStoreException {
        ...
        if (value == null) {
            ...
            try {
                ...
                getLazyUserStoreLoader().put(userStoreRealmConfig.getUserStoreProperty(UserCoreConstants.RealmConfig.PROPERTY_DOMAIN_NAME), userStoreRealmConfig);
    ...
    public void initializeSecondaryUserStores() throws UserStoreException {
...
//        }
        ...
        try {
            UserStoreManager manager = (UserStoreManager) createObjectWithOptions(lazyLoadingUserStoreClass,
                    lazyLoadingRealmConfig, properties);

            lastUserStoreManager.setSecondaryUserStoreManager(manager);
            userStoreManager.addSecondaryUserStoreManager(domainName,
                    lastUserStoreManager.getSecondaryUserStoreManager());
...
//            getLazyUserStoreLoader().put(tenantId, realmConfig);
    ...
    public Map<String, RealmConfiguration> getLazyUserStoreLoader() {

        return lazyUserStoreLoader;
    }

    public void setLazyUserStoreLoader(Map<String, RealmConfiguration> lazyUserStoreLoader) {

        this.lazyUserStoreLoader = lazyUserStoreLoader;
    }
}
