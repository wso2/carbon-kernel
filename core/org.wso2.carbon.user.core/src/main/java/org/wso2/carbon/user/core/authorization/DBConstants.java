...
public class DBConstants {
    ...
    public static final String DELETE_PERMISSION_BY_TENANT_ID_SQL = "DELETE FROM UM_PERMISSION WHERE UM_TENANT_ID=?";
    ...
    public static final String DELETE_USER_PERMISSIONS_BY_TENANT_ID_SQL = "DELETE FROM UM_USER_PERMISSION " +
            "WHERE UM_TENANT_ID = ?";
    public static final String ON_DELETE_ROLE_DELETE_PERMISSION_SQL = "DELETE FROM UM_ROLE_PERMISSION " +
    ...
    public static final String DELETE_ROLE_PERMISSIONS_BY_TENANT_ID_SQL = "DELETE FROM UM_ROLE_PERMISSION " +
            "WHERE UM_TENANT_ID = ?";
