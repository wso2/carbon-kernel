...
public interface UniqueIDUserStoreManager extends UserStoreManager {
    ...
    // Group centric interface methods --------------------------------------------------------------------------------.
     ...
     * @throws UserStoreException thrown by the underlying UserStoreManager.
     */
    Group addGroup(String groupName, List<String> userIDList, List<Permission> permissions,
    ...
    // User centric interface methods that can use Group object -----------------------------------------------------
