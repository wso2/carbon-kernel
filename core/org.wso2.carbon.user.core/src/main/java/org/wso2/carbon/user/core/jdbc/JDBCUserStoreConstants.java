...
public class JDBCUserStoreConstants {
    ...
    static {
        ...
        setProperty(UserStoreConfigConstants.CASE_SENSITIVE_USERNAME, "Case Insensitive Username", "true",
        ...
        setAdvancedProperty(JDBCRealmConstants.SELECT_USER_CASE_INSENSITIVE, "Select User SQL With " +
                "Case Insensitivie Username", JDBCRealmConstants.SELECT_USER_SQL_CASE_INSENSITIVE, "");
        ...
        setAdvancedProperty(JDBCRealmConstants.GET_USER_FILTER_CASE_INSENSITIVE, "User Filter SQL With" +
                        " Case Insensitive Username", JDBCRealmConstants.GET_USER_FILTER_SQL_CASE_INSENSITIVE,
                "");
        setAdvancedProperty(JDBCRealmConstants.GET_USER_ROLE, "User Role SQL", JDBCRealmConstants.GET_USER_ROLE_SQL, "");
        setAdvancedProperty(JDBCRealmConstants.GET_USER_ROLE_CASE_INSENSITIVE, "User Role SQL With " +
                "Case Insensitive Username", JDBCRealmConstants.GET_USER_ROLE_SQL_CASE_INSENSITIVE, "");
        ...
        setAdvancedProperty(JDBCRealmConstants.GET_SHARED_ROLES_FOR_USER_CASE_INSENSITIVE, "User " +
                "Shared Role SQL With Case Insensitive Username", JDBCRealmConstants
        ...
        setAdvancedProperty(JDBCRealmConstants.GET_IS_USER_EXISTING_CASE_INSENSITIVE, "Is User " +
                "Existing SQL With Case Insensitive Username", JDBCRealmConstants
        ...
        setAdvancedProperty(JDBCRealmConstants.GET_PROPS_FOR_PROFILE_CASE_INSENSITIVE, "Get User " +
                "Properties for Profile SQL With Case Insensitive Username", JDBCRealmConstants
        ...
        setAdvancedProperty(JDBCRealmConstants.GET_PROP_FOR_PROFILE_CASE_INSENSITIVE, "Get User " +
                "Property for Profile SQL With Case Insensitive Username", JDBCRealmConstants
        ...
        setAdvancedProperty(JDBCRealmConstants.GET_PROFILE_NAMES_FOR_USER_CASE_INSENSITIVE, "Get User " +
                "Profile Names SQL With Case Insensitive Username", JDBCRealmConstants
        ...
        setAdvancedProperty(JDBCRealmConstants.GET_USERID_FROM_USERNAME_CASE_INSENSITIVE, "Get User ID" +
                " From Username SQL With Case Insensitive Username", JDBCRealmConstants
        ...
        setAdvancedProperty(JDBCRealmConstants.GET_TENANT_ID_FROM_USERNAME_CASE_INSENSITIVE, "Get " +
                "Tenant ID From Username SQL With Case Insensitive Username", JDBCRealmConstants
        ...
        setAdvancedProperty(JDBCRealmConstants.ADD_USER_TO_ROLE_CASE_INSENSITIVE, "Add User To Role " +
        ...
        setAdvancedProperty(JDBCRealmConstants.ADD_SHARED_ROLE_TO_USER_CASE_INSENSITIVE, "Add Shared " +
                "Role To User SQL With Case Insensitive Username", JDBCRealmConstants
        ...
        setAdvancedProperty(JDBCRealmConstants.REMOVE_USER_FROM_ROLE_CASE_INSENSITIVE, "Remove User " +
                "From Role SQL With Case Insensitive Username", JDBCRealmConstants
        ...
        setAdvancedProperty(JDBCRealmConstants.REMOVE_ROLE_FROM_USER_CASE_INSENSITIVE, "Remove Role " +
                "From User SQL With Case Insensitive Username", JDBCRealmConstants
        ...
        setAdvancedProperty(JDBCRealmConstants.DELETE_USER_CASE_INSENSITIVE, "Delete User SQL With " +
                "Case Insensitive Username", JDBCRealmConstants.DELETE_USER_SQL_CASE_INSENSITIVE, "");
        ...
        setAdvancedProperty(JDBCRealmConstants.ON_DELETE_USER_REMOVE_ATTRIBUTE_CASE_INSENSITIVE, "On " +
        ...
        setAdvancedProperty(JDBCRealmConstants.UPDATE_USER_PASSWORD_CASE_INSENSITIVE, "Update User " +
                "Password SQL With Case Insensitive Username", JDBCRealmConstants
        ...
        setAdvancedProperty(JDBCRealmConstants.UPDATE_USER_PROPERTY_CASE_INSENSITIVE, "Update User " +
                "Property SQL With Case Insensitive Username", JDBCRealmConstants
        ...
        setAdvancedProperty(JDBCRealmConstants.DELETE_USER_PROPERTY_CASE_INSENSITIVE, "Delete User " +
                "Property SQL With Case Insensitive Username", JDBCRealmConstants
        ...
        setAdvancedProperty(JDBCRealmConstants.USER_NAME_UNIQUE_CASE_INSENSITIVE, "User Name Unique " +
                "Across Tenant SQL With Case Insensitive Username", JDBCRealmConstants
        ...
        setAdvancedProperty(JDBCRealmConstants.ADD_USER_TO_ROLE_CASE_INSENSITIVE_MSSQL, "Add User To " +
                "Role SQL With Case Insensitive Username (MSSQL)", JDBCRealmConstants
                .ADD_USER_TO_ROLE_MSSQL_SQL_CASE_INSENSITIVE, "");
        setAdvancedProperty(JDBCRealmConstants.ADD_ROLE_TO_USER_CASE_INSENSITIVE_MSSQL, "Add Role To " +
                "User SQL With Case Insensitive Username (MSSQL)", JDBCRealmConstants
                .ADD_ROLE_TO_USER_MSSQL_SQL_CASE_INSENSITIVE, "");
        setAdvancedProperty(JDBCRealmConstants.ADD_USER_PROPERTY_CASE_INSENSITIVE_MSSQL, "Add User " +
                "Property With Case Insensitive Username (MSSQL)", JDBCRealmConstants
        ...
        setAdvancedProperty(JDBCRealmConstants.ADD_USER_TO_ROLE_CASE_INSENSITIVE_OPENEDGE, "Add User " +
                "To Role SQL With Case Insensitive Username (OpenEdge)", JDBCRealmConstants
                .ADD_USER_TO_ROLE_OPENEDGE_SQL_CASE_INSENSITIVE, "");
        setAdvancedProperty(JDBCRealmConstants.ADD_ROLE_TO_USER_CASE_INSENSITIVE_OPENEDGE, "Add Role " +
                "To User SQL With Case Insensitive Username (OpenEdge)", JDBCRealmConstants
                .ADD_ROLE_TO_USER_OPENEDGE_SQL_CASE_INSENSITIVE, "");
        setAdvancedProperty(JDBCRealmConstants.ADD_USER_PROPERTY_CASE_INSENSITIVE_OPENEDGE, "Add User " +
                "Property With Case Insensitive Username (OpenEdge)", JDBCRealmConstants
