    ...
    public final void updateCredential(String userName, Object newCredential, Object oldCredential)
        ...
        try {
            ...
            if (isUniqueUserIdEnabled) {
                ...
                isAuthenticated = this.doAuthenticateWithID(preferredUserNameProperty, userName, oldCredentialObj, null)
                        .getAuthenticationStatus() == AuthenticationResult.AuthenticationStatus.SUCCESS;
            } else {
                isAuthenticated = this.doAuthenticate(userName, oldCredentialObj);
            }
