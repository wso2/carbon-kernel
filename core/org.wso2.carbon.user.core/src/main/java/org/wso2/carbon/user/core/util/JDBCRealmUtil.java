/*
 * Copyright (c) 2009-2024, WSO2 LLC. (http://www.wso2.com).
 *
...
public class JDBCRealmUtil {
    ...
    public static Map<String, String> getSQL(Map<String, String> properties) {
        ...
        if (!properties.containsKey(JDBCRealmConstants.SELECT_USER_ID_FROM_USER_NAME)) {
            properties.put(JDBCRealmConstants.SELECT_USER_ID_FROM_USER_NAME,
        ...
        if (!properties.containsKey(JDBCRealmConstants.GET_ROLE_LIST_WITH_ESCAPE_H2)) {
            properties.put(JDBCRealmConstants.GET_ROLE_LIST_WITH_ESCAPE_H2,
        ...
        if (!properties.containsKey(JDBCRealmConstants.SELECT_USER_PROPERTIES_WITH_ID_OPTIMIZED)) {
            properties.put(JDBCRealmConstants.SELECT_USER_PROPERTIES_WITH_ID_OPTIMIZED,
