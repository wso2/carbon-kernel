...
public class JDBCRealmUtil {
    ...
    public static Map<String, String> getSQL(Map<String, String> properties) {
        ...
        if (!properties.containsKey(JDBCRealmConstants.SELECT_USER_CASE_INSENSITIVE)) {
            properties.put(JDBCRealmConstants.SELECT_USER_CASE_INSENSITIVE, JDBCRealmConstants
        ...
        if (!properties.containsKey(JDBCRealmConstants.GET_USER_ROLE_CASE_INSENSITIVE)) {
            properties.put(JDBCRealmConstants.GET_USER_ROLE_CASE_INSENSITIVE, JDBCRealmConstants
        ...
        if (!properties.containsKey(JDBCRealmConstants.GET_SHARED_ROLES_FOR_USER_CASE_INSENSITIVE)) {
            properties.put(JDBCRealmConstants.GET_SHARED_ROLES_FOR_USER_CASE_INSENSITIVE,
                    JDBCRealmConstants.GET_SHARED_ROLES_FOR_USER_SQL_CASE_INSENSITIVE);
        }
        ...
        if (!properties.containsKey(JDBCRealmConstants.GET_USER_FILTER_CASE_INSENSITIVE)) {
            properties.put(JDBCRealmConstants.GET_USER_FILTER_CASE_INSENSITIVE,
                    JDBCRealmConstants.GET_USER_FILTER_SQL_CASE_INSENSITIVE);
        }
        ...
        if (!properties.containsKey(JDBCRealmConstants.GET_IS_USER_EXISTING_CASE_INSENSITIVE)) {
            properties.put(JDBCRealmConstants.GET_IS_USER_EXISTING_CASE_INSENSITIVE,
                    JDBCRealmConstants.GET_IS_USER_EXISTING_SQL_CASE_INSENSITIVE);
        }
        ...
        if (!properties.containsKey(JDBCRealmConstants.GET_PROPS_FOR_PROFILE_CASE_INSENSITIVE)) {
            properties.put(JDBCRealmConstants.GET_PROPS_FOR_PROFILE_CASE_INSENSITIVE,
                    JDBCRealmConstants.GET_PROPS_FOR_PROFILE_SQL_CASE_INSENSITIVE);
        }
        ...
        if (!properties.containsKey(JDBCRealmConstants.GET_PROP_FOR_PROFILE_CASE_INSENSITIVE)) {
            properties.put(JDBCRealmConstants.GET_PROP_FOR_PROFILE_CASE_INSENSITIVE,
                    JDBCRealmConstants.GET_PROP_FOR_PROFILE_SQL_CASE_INSENSITIVE);
        }
        ...
        if (!properties.containsKey(JDBCRealmConstants.GET_PROFILE_NAMES_FOR_USER_CASE_INSENSITIVE)) {
            properties.put(JDBCRealmConstants.GET_PROFILE_NAMES_FOR_USER_CASE_INSENSITIVE,
                    JDBCRealmConstants.GET_PROFILE_NAMES_FOR_USER_SQL_CASE_INSENSITIVE);
        }
        ...
        if (!properties.containsKey(JDBCRealmConstants.GET_USERID_FROM_USERNAME_CASE_INSENSITIVE)) {
            properties.put(JDBCRealmConstants.GET_USERID_FROM_USERNAME_CASE_INSENSITIVE,
                    JDBCRealmConstants.GET_USERID_FROM_USERNAME_SQL_CASE_INSENSITIVE);
        }
        ...
        if (!properties.containsKey(JDBCRealmConstants.GET_TENANT_ID_FROM_USERNAME_CASE_INSENSITIVE)) {
            properties.put(JDBCRealmConstants.GET_TENANT_ID_FROM_USERNAME_CASE_INSENSITIVE,
                    JDBCRealmConstants.GET_TENANT_ID_FROM_USERNAME_SQL_CASE_INSENSITIVE);
        }
        ...
        if (!properties.containsKey(JDBCRealmConstants.ADD_USER_TO_ROLE_CASE_INSENSITIVE)) {
            properties.put(JDBCRealmConstants.ADD_USER_TO_ROLE_CASE_INSENSITIVE,
                    JDBCRealmConstants.ADD_USER_TO_ROLE_SQL_CASE_INSENSITIVE);
        }
        ...
        if (!properties.containsKey(JDBCRealmConstants.ADD_ROLE_TO_USER_CASE_INSENSITIVE)) {
            properties.put(JDBCRealmConstants.ADD_ROLE_TO_USER_CASE_INSENSITIVE,
                    JDBCRealmConstants.ADD_ROLE_TO_USER_SQL_CASE_INSENSITIVE);
        }
        ...
        if (!properties.containsKey(JDBCRealmConstants.ADD_SHARED_ROLE_TO_USER_CASE_INSENSITIVE)) {
            properties.put(JDBCRealmConstants.ADD_SHARED_ROLE_TO_USER_CASE_INSENSITIVE,
                    JDBCRealmConstants.ADD_SHARED_ROLE_TO_USER_SQL_CASE_INSENSITIVE);
        }
        ...
        if (!properties.containsKey(JDBCRealmConstants.REMOVE_USER_FROM_ROLE_CASE_INSENSITIVE)) {
            properties.put(JDBCRealmConstants.REMOVE_USER_FROM_ROLE_CASE_INSENSITIVE,
                    JDBCRealmConstants.REMOVE_USER_FROM_ROLE_SQL_CASE_INSENSITIVE);
        }
        ...
        if (!properties.containsKey(JDBCRealmConstants.REMOVE_USER_FROM_SHARED_ROLE_CASE_INSENSITIVE)) {
            properties.put(JDBCRealmConstants.REMOVE_USER_FROM_SHARED_ROLE_CASE_INSENSITIVE,
        ...
        if (!properties.containsKey(JDBCRealmConstants.REMOVE_ROLE_FROM_USER_CASE_INSENSITIVE)) {
            properties.put(JDBCRealmConstants.REMOVE_ROLE_FROM_USER_CASE_INSENSITIVE,
                    JDBCRealmConstants.REMOVE_ROLE_FROM_USER_SQL_CASE_INSENSITIVE);
        }
        ...
        if (!properties.containsKey(JDBCRealmConstants.DELETE_USER_CASE_INSENSITIVE)) {
            properties.put(JDBCRealmConstants.DELETE_USER_CASE_INSENSITIVE, JDBCRealmConstants
        ...
        if (!properties.containsKey(JDBCRealmConstants.ON_DELETE_USER_REMOVE_USER_ROLE_CASE_INSENSITIVE)) {
            properties.put(JDBCRealmConstants.ON_DELETE_USER_REMOVE_USER_ROLE_CASE_INSENSITIVE,
                    JDBCRealmConstants.ON_DELETE_USER_REMOVE_USER_ROLE_SQL_CASE_INSENSITIVE);
        }
        ...
        if (!properties.containsKey(JDBCRealmConstants.ON_DELETE_USER_REMOVE_ATTRIBUTE_CASE_INSENSITIVE)) {
            properties.put(JDBCRealmConstants.ON_DELETE_USER_REMOVE_ATTRIBUTE_CASE_INSENSITIVE,
                    JDBCRealmConstants.ON_DELETE_USER_REMOVE_ATTRIBUTE_SQL_CASE_INSENSITIVE);
        }
        ...
        if (!properties.containsKey(JDBCRealmConstants.UPDATE_USER_PASSWORD_CASE_INSENSITIVE)) {
            properties.put(JDBCRealmConstants.UPDATE_USER_PASSWORD_CASE_INSENSITIVE,
                    JDBCRealmConstants.UPDATE_USER_PASSWORD_SQL_CASE_INSENSITIVE);
        }
        ...
        if (!properties.containsKey(JDBCRealmConstants.USER_NAME_UNIQUE_CASE_INSENSITIVE)) {
            properties.put(JDBCRealmConstants.USER_NAME_UNIQUE_CASE_INSENSITIVE,
                    JDBCRealmConstants.USER_NAME_UNIQUE_SQL_CASE_INSENSITIVE);
        }
        ...
        if (!properties.containsKey(JDBCRealmConstants.UPDATE_USER_PROPERTY_CASE_INSENSITIVE)) {
            properties.put(JDBCRealmConstants.UPDATE_USER_PROPERTY_CASE_INSENSITIVE,
                    JDBCRealmConstants.UPDATE_USER_PROPERTY_SQL_CASE_INSENSITIVE);
        }
        ...
        if (!properties.containsKey(JDBCRealmConstants.DELETE_USER_PROPERTY_CASE_INSENSITIVE)) {
            properties.put(JDBCRealmConstants.DELETE_USER_PROPERTY_CASE_INSENSITIVE,
                    JDBCRealmConstants.DELETE_USER_PROPERTY_SQL_CASE_INSENSITIVE);
        }
        ...
        if (!properties.containsKey(JDBCRealmConstants.ADD_USER_TO_ROLE_CASE_INSENSITIVE_MSSQL)) {
            properties.put(JDBCRealmConstants.ADD_USER_TO_ROLE_CASE_INSENSITIVE_MSSQL,
                    JDBCRealmConstants.ADD_USER_TO_ROLE_MSSQL_SQL_CASE_INSENSITIVE);
        }
        ...
        if (!properties.containsKey(JDBCRealmConstants.ADD_ROLE_TO_USER_CASE_INSENSITIVE_MSSQL)) {
            properties.put(JDBCRealmConstants.ADD_ROLE_TO_USER_CASE_INSENSITIVE_MSSQL,
                    JDBCRealmConstants.ADD_ROLE_TO_USER_MSSQL_SQL_CASE_INSENSITIVE);
        }
        ...
        if (!properties.containsKey(JDBCRealmConstants.ADD_USER_PROPERTY_CASE_INSENSITIVE_MSSQL)) {
            properties.put(JDBCRealmConstants.ADD_USER_PROPERTY_CASE_INSENSITIVE_MSSQL,
                    JDBCRealmConstants.ADD_USER_PROPERTY_MSSQL_SQL_CASE_INSENSITIVE);
        }
        ...
        if (!properties.containsKey(JDBCRealmConstants.ADD_USER_TO_ROLE_CASE_INSENSITIVE_OPENEDGE)) {
            properties.put(JDBCRealmConstants.ADD_USER_TO_ROLE_CASE_INSENSITIVE_OPENEDGE,
                    JDBCRealmConstants.ADD_USER_TO_ROLE_OPENEDGE_SQL_CASE_INSENSITIVE);
        }
        ...
        if (!properties.containsKey(JDBCRealmConstants.ADD_ROLE_TO_USER_CASE_INSENSITIVE_OPENEDGE)) {
            properties.put(JDBCRealmConstants.ADD_ROLE_TO_USER_CASE_INSENSITIVE_OPENEDGE,
                    JDBCRealmConstants.ADD_ROLE_TO_USER_OPENEDGE_SQL_CASE_INSENSITIVE);
        }
        ...
        if (!properties.containsKey(JDBCRealmConstants.ADD_USER_PROPERTY_CASE_INSENSITIVE_OPENEDGE)) {
            properties.put(JDBCRealmConstants.ADD_USER_PROPERTY_CASE_INSENSITIVE_OPENEDGE,
                    JDBCRealmConstants.ADD_USER_PROPERTY_OPENEDGE_SQL_CASE_INSENSITIVE);
        }
        return properties;
    }
}
