...
public class JDBCCaseInsensitiveConstants {
    ...
    public static final String SELECT_USER_SQL_CASE_INSENSITIVE = "SELECT UM_ID, UM_USER_NAME, UM_USER_PASSWORD, UM_SALT_VALUE, UM_REQUIRE_CHANGE, UM_CHANGED_TIME FROM UM_USER WHERE LOWER(UM_USER_NAME)" +
