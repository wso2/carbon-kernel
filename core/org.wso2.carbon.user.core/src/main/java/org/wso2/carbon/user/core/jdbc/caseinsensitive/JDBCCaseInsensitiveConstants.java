...
public class JDBCCaseInsensitiveConstants {
    ...
    public static final String GET_ROLE_LIST_OF_USER_SQL_CASE_INSENSITIVE_WITH_AUDIENCE = "SELECT UM_ROLE_NAME FROM " +
            "UM_HYBRID_USER_ROLE, UM_HYBRID_ROLE WHERE LOWER(UM_USER_NAME)=LOWER(?) AND UM_HYBRID_USER_ROLE" +
            ".UM_ROLE_ID=UM_HYBRID_ROLE.UM_ID AND UM_HYBRID_USER_ROLE.UM_TENANT_ID=? AND UM_HYBRID_ROLE" +
    ...
    public static final String GET_ROLE_V2_LIST_OF_USER_SQL_CASE_INSENSITIVE_WITH_AUDIENCE = "SELECT UM_ROLE_NAME FROM " +
    ...
    public static final String GET_IS_USER_ROLE_SQL_CASE_INSENSITIVE_WITH_AUDIENCE = "SELECT UM_ROLE_NAME FROM "
            + "UM_HYBRID_USER_ROLE, UM_HYBRID_ROLE WHERE LOWER(UM_USER_NAME)=LOWER(?) AND "
            + "UM_HYBRID_USER_ROLE.UM_ROLE_ID=UM_HYBRID_ROLE.UM_ID AND UM_HYBRID_USER_ROLE.UM_TENANT_ID=? AND "
            + "UM_HYBRID_ROLE.UM_TENANT_ID=? AND UM_HYBRID_ROLE.UM_AUDIENCE_REF_ID=-1 AND UM_HYBRID_USER_ROLE.UM_DOMAIN_ID=(SELECT UM_DOMAIN_ID FROM UM_DOMAIN WHERE "
            + "UM_TENANT_ID=? AND UM_DOMAIN_NAME=?) AND UM_ROLE_NAME LIKE ?";
    public static final String GET_IS_USER_ROLE_V2_SQL_CASE_INSENSITIVE_WITH_AUDIENCE = "SELECT UM_ROLE_NAME FROM "
    ...
    public static final String GET_INTERNAL_ROLE_LIST_OF_USERS_SQL_CASE_INSENSITIVE_WITH_AUDIENCE = "SELECT UM_USER_NAME, UM_ROLE_NAME FROM " +
            "UM_HYBRID_USER_ROLE, UM_HYBRID_ROLE WHERE LOWER(UM_USER_NAME) IN (?) AND UM_HYBRID_USER_ROLE" +
            ".UM_ROLE_ID=UM_HYBRID_ROLE.UM_ID AND UM_HYBRID_USER_ROLE.UM_TENANT_ID=? AND UM_HYBRID_ROLE" +
            ".UM_TENANT_ID=? AND UM_HYBRID_ROLE.UM_AUDIENCE_REF_ID=-1 AND UM_HYBRID_USER_ROLE.UM_DOMAIN_ID=(SELECT UM_DOMAIN_ID FROM UM_DOMAIN WHERE " +
            "UM_TENANT_ID=? AND UM_DOMAIN_NAME=?)";
    public static final String GET_INTERNAL_ROLE_V2_LIST_OF_USERS_SQL_CASE_INSENSITIVE_WITH_AUDIENCE = "SELECT UM_USER_NAME, UM_ROLE_NAME, UM_AUDIENCE, UM_AUDIENCE_ID FROM " +
