...
public class JDBCCaseInsensitiveConstants {
    ...
    public static final String GET_USER_FILTER_WITH_ID_CASE_INSENSITIVE_PAGINATED_MSSQL =
    ...
    public static final String GET_USER_FILTER_CASE_INSENSITIVE_PAGINATED_WITH_ID_SQL_MSSQL =
            "SELECT UM_USER_ID, UM_USER_NAME FROM (SELECT UM_USER_ID, UM_USER_NAME, UM_TENANT_ID, "
                    + "ROW_NUMBER() OVER (ORDER BY UM_USER_NAME) AS RowNum FROM UM_USER "
                    + "WHERE LOWER(UM_USER_NAME) LIKE LOWER(?) AND UM_TENANT_ID=?) AS P WHERE P.RowNum BETWEEN ? AND ?";
