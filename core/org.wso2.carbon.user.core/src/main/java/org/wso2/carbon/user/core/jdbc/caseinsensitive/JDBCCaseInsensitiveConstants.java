...
public class JDBCCaseInsensitiveConstants {
    ...
    public static final String ADD_USER_PROPERTY_SQL_CASE_INSENSITIVE_UNICODE = "INSERT INTO UM_USER_ATTRIBUTE " +
            "(UM_USER_ID, UM_ATTR_NAME, UM_ATTR_VALUE, UM_ATTR_VALUE_UNICODE, UM_PROFILE_ID, UM_TENANT_ID) " +
            "VALUES ((SELECT UM_ID FROM UM_USER WHERE LOWER(UM_USER_NAME)=LOWER(?) AND UM_TENANT_ID=?), ?, ?, ?, ?, ?)";
    ...
    public static final String SELECT_USER_WITH_ID_SQL_CASE_INSENSITIVE_HYBRID = "SELECT UM_USER.UM_USER_ID, UM_USER" +
            ".UM_USER_NAME, UM_USER.UM_USER_PASSWORD, UM_USER.UM_SALT_VALUE, UM_USER.UM_REQUIRE_CHANGE, UM_USER" +
            ".UM_CHANGED_TIME FROM UM_USER, UM_USER_ATTRIBUTE WHERE UM_USER_ATTRIBUTE.UM_USER_ID = UM_USER.UM_ID " +
            "AND UM_USER_ATTRIBUTE.UM_ATTR_NAME =? AND LOWER(COALESCE(UM_USER_ATTRIBUTE.UM_ATTR_VALUE_UNICODE, " +
            "UM_USER_ATTRIBUTE.UM_ATTR_VALUE)) =LOWER(?) AND UM_USER_ATTRIBUTE.UM_PROFILE_ID=? AND UM_USER_ATTRIBUTE" +
    ...
    public static final String GET_PROPS_FOR_PROFILE_SQL_CASE_INSENSITIVE = "SELECT UM_ATTR_NAME, UM_ATTR_VALUE FROM " +
            ...
            ".UM_TENANT_ID=?";
    public static final String GET_PROPS_FOR_PROFILE_SQL_CASE_INSENSITIVE_HYBRID = "SELECT UM_ATTR_NAME, COALESCE(" +
            "UM_ATTR_VALUE_UNICODE, UM_ATTR_VALUE) FROM UM_USER_ATTRIBUTE, UM_USER WHERE UM_USER.UM_ID = " +
            "UM_USER_ATTRIBUTE.UM_USER_ID AND LOWER(UM_USER.UM_USER_NAME)=LOWER(?) AND UM_PROFILE_ID=? AND " +
    ...
    public static final String GET_USERS_PROPS_FOR_PROFILE_SQL_CASE_INSENSITIVE = "SELECT UM_USER_NAME,UM_ATTR_NAME," +
            ...
            ".UM_TENANT_ID=?";
    public static final String GET_USERS_PROPS_FOR_PROFILE_SQL_CASE_INSENSITIVE_HYBRID = "SELECT UM_USER_NAME, " +
            "UM_ATTR_NAME, COALESCE(UM_ATTR_VALUE_UNICODE, UM_ATTR_VALUE) FROM UM_USER_ATTRIBUTE, UM_USER WHERE " +
            "UM_USER.UM_ID = UM_USER_ATTRIBUTE.UM_USER_ID AND LOWER(UM_USER.UM_USER_NAME) IN (?) AND UM_PROFILE_ID=? " +
    ...
    public static final String GET_USERS_FOR_PROP_WITH_ID_SQL_CASE_INSENSITIVE = "SELECT DISTINCT UM_USER.UM_USER_ID " +
            ...
            "UM_USER_ATTRIBUTE.UM_PROFILE_ID=? AND UM_USER_ATTRIBUTE.UM_TENANT_ID=? AND UM_USER.UM_TENANT_ID=?";
    public static final String GET_USERS_FOR_PROP_WITH_ID_SQL_CASE_INSENSITIVE_HYBRID = "SELECT DISTINCT UM_USER" +
            ".UM_USER_ID FROM UM_USER, UM_USER_ATTRIBUTE WHERE UM_USER_ATTRIBUTE.UM_USER_ID = UM_USER.UM_ID AND " +
            "UM_USER_ATTRIBUTE.UM_ATTR_NAME =? AND LOWER(COALESCE(UM_USER_ATTRIBUTE.UM_ATTR_VALUE_UNICODE, " +
            "UM_USER_ATTRIBUTE.UM_ATTR_VALUE)) LIKE LOWER(?) AND UM_USER_ATTRIBUTE.UM_PROFILE_ID=? AND " +
            "UM_USER_ATTRIBUTE.UM_TENANT_ID=? AND UM_USER.UM_TENANT_ID=?";
    public static final String GET_USERS_FOR_CLAIM_VALUE_WITH_ID_SQL_CASE_INSENSITIVE = "SELECT DISTINCT UM_USER" +
            ...
            "UM_USER_ATTRIBUTE.UM_PROFILE_ID=? AND UM_USER_ATTRIBUTE.UM_TENANT_ID=? AND UM_USER.UM_TENANT_ID=?";
    public static final String GET_USERS_FOR_CLAIM_VALUE_WITH_ID_SQL_CASE_INSENSITIVE_HYBRID = "SELECT DISTINCT UM_USER" +
            ".UM_USER_ID FROM UM_USER, UM_USER_ATTRIBUTE WHERE UM_USER_ATTRIBUTE.UM_USER_ID = UM_USER.UM_ID AND " +
            "UM_USER_ATTRIBUTE.UM_ATTR_NAME =? AND LOWER(COALESCE(UM_USER_ATTRIBUTE.UM_ATTR_VALUE_UNICODE, " +
            "UM_USER_ATTRIBUTE.UM_ATTR_VALUE))=LOWER(?) AND UM_USER_ATTRIBUTE.UM_PROFILE_ID=? AND UM_USER_ATTRIBUTE" +
            ".UM_TENANT_ID=? AND UM_USER.UM_TENANT_ID=?";
    ...
    public static final String GET_PROP_FOR_PROFILE_SQL_CASE_INSENSITIVE_HYBRID = "SELECT COALESCE(UM_ATTR_VALUE_UNICODE, " +
            "UM_ATTR_VALUE) FROM UM_USER_ATTRIBUTE, UM_USER WHERE UM_USER.UM_ID = UM_USER_ATTRIBUTE.UM_USER_ID AND " +
            "LOWER(UM_USER.UM_USER_NAME)=LOWER(?) AND UM_ATTR_NAME=? AND UM_PROFILE_ID=? AND UM_USER_ATTRIBUTE" +
            ".UM_TENANT_ID=? AND UM_USER.UM_TENANT_ID=?";
    ...
    public static final String UPDATE_USER_PROPERTY_SQL_CASE_INSENSITIVE_UNICODE = "UPDATE UM_USER_ATTRIBUTE SET " +
            "UM_ATTR_VALUE=?, UM_ATTR_VALUE_UNICODE=? WHERE UM_USER_ID=(SELECT UM_ID FROM UM_USER WHERE LOWER" +
            "(UM_USER_NAME)=LOWER(?) AND UM_TENANT_ID=?) AND UM_ATTR_NAME=? AND UM_PROFILE_ID=? AND UM_TENANT_ID=?";
    ...
    public static final String USER_NAME_UNIQUE_SQL_CASE_INSENSITIVE_WITH_ID_HYBRID =
            "SELECT UM_ID FROM UM_USER_ATTRIBUTE WHERE UM_ATTR_NAME=? AND LOWER(COALESCE(UM_ATTR_VALUE_UNICODE, " +
            "UM_ATTR_VALUE))=LOWER(?)";
    ...
    public static final String ADD_USER_PROPERTY_MSSQL_SQL_CASE_INSENSITIVE_UNICODE = "INSERT INTO UM_USER_ATTRIBUTE " +
            "(UM_USER_ID, UM_ATTR_NAME, UM_ATTR_VALUE, UM_ATTR_VALUE_UNICODE, UM_PROFILE_ID, UM_TENANT_ID) SELECT " +
            "(SELECT UM_ID FROM UM_USER WHERE LOWER(UM_USER_NAME)=LOWER(?) AND UM_TENANT_ID=?), (?), (?), (?), (?), (?)";
    ...
    public static final String GET_ROLE_V2_LIST_OF_USER_SQL_CASE_INSENSITIVE = "SELECT UM_ROLE_NAME FROM " +
            "UM_HYBRID_USER_ROLE, UM_HYBRID_ROLE, UM_HYBRID_ROLE_AUDIENCE WHERE LOWER(UM_USER_NAME)=LOWER(?) AND UM_HYBRID_USER_ROLE" +
            ".UM_ROLE_ID=UM_HYBRID_ROLE.UM_ID AND UM_HYBRID_USER_ROLE.UM_TENANT_ID=? AND UM_HYBRID_ROLE" +
            ".UM_TENANT_ID=? AND UM_HYBRID_ROLE.UM_AUDIENCE_REF_ID = UM_HYBRID_ROLE_AUDIENCE.UM_ID AND " +
            "UM_HYBRID_USER_ROLE.UM_DOMAIN_ID=(SELECT UM_DOMAIN_ID FROM UM_DOMAIN WHERE UM_TENANT_ID=? AND UM_DOMAIN_NAME=?)";
    ...
    public static final String GET_IS_USER_ROLE_V2_SQL_CASE_INSENSITIVE = "SELECT UM_ROLE_NAME FROM "
            + "UM_HYBRID_USER_ROLE, UM_HYBRID_ROLE, UM_HYBRID_ROLE_AUDIENCE WHERE LOWER(UM_USER_NAME)=LOWER(?) AND "
            + "UM_HYBRID_USER_ROLE.UM_ROLE_ID=UM_HYBRID_ROLE.UM_ID AND UM_HYBRID_USER_ROLE.UM_TENANT_ID=? AND "
            + "UM_HYBRID_ROLE.UM_TENANT_ID=? AND UM_HYBRID_ROLE.UM_AUDIENCE_REF_ID = UM_HYBRID_ROLE_AUDIENCE.UM_ID AND " +
            "UM_HYBRID_USER_ROLE.UM_DOMAIN_ID=(SELECT UM_DOMAIN_ID FROM UM_DOMAIN WHERE "
            + "UM_TENANT_ID=? AND UM_DOMAIN_NAME=?) AND UM_ROLE_NAME LIKE ?";
    ...
    public static final String GET_INTERNAL_ROLE_V2_LIST_OF_USERS_SQL_CASE_INSENSITIVE = "SELECT UM_USER_NAME, UM_ROLE_NAME FROM " +
            "UM_HYBRID_USER_ROLE, UM_HYBRID_ROLE, UM_HYBRID_ROLE_AUDIENCE WHERE LOWER(UM_USER_NAME) IN (?) AND UM_HYBRID_USER_ROLE" +
            ".UM_ROLE_ID=UM_HYBRID_ROLE.UM_ID AND UM_HYBRID_USER_ROLE.UM_TENANT_ID=? AND UM_HYBRID_ROLE" +
            ".UM_TENANT_ID=? AND UM_HYBRID_ROLE.UM_AUDIENCE_REF_ID = UM_HYBRID_ROLE_AUDIENCE.UM_ID AND " +
            "UM_HYBRID_USER_ROLE.UM_DOMAIN_ID=(SELECT UM_DOMAIN_ID FROM UM_DOMAIN WHERE " +
            "UM_TENANT_ID=? AND UM_DOMAIN_NAME=?)";
