...
public class HybridJDBCConstants {
    ...
    public static final String GET_IS_GROUP_EXISTING_IN_UM_HYBRID_GROUP_ROLE_SQL =
            "SELECT UM_ID FROM UM_HYBRID_GROUP_ROLE WHERE UM_GROUP_NAME=? AND UM_DOMAIN_ID=(SELECT UM_DOMAIN_ID " +
                    "FROM UM_DOMAIN WHERE UM_TENANT_ID=? AND UM_DOMAIN_NAME=?) AND UM_TENANT_ID=?";
