...
public class HybridJDBCConstants {
    ...
    public static final String GET_ROLES =
            "SELECT UM_ROLE_NAME FROM UM_HYBRID_ROLE WHERE UPPER(UM_ROLE_NAME) LIKE ? AND UM_TENANT_ID=?";
    public static final String GET_INTERNAL_ROLES =
            "SELECT UM_ROLE_NAME FROM UM_HYBRID_ROLE WHERE UPPER(UM_ROLE_NAME) LIKE ? AND NOT UM_ROLE_NAME LIKE ? AND " +
                    "UM_TENANT_ID=?";
    ...
    public static final String GET_USER_LIST_OF_ROLE_SQL = "SELECT UM_USER_NAME, UM_DOMAIN_NAME FROM UM_HYBRID_USER_ROLE, UM_DOMAIN WHERE " +
            "UM_ROLE_ID=(SELECT UM_ID FROM UM_HYBRID_ROLE WHERE UPPER(UM_ROLE_NAME)=? AND UM_TENANT_ID=?) AND UM_HYBRID_USER_ROLE.UM_TENANT_ID=? " +
    ...
    public static final String GET_GROUP_LIST_OF_ROLE_SQL =
            "SELECT UM_GROUP_NAME, UM_DOMAIN_NAME FROM UM_HYBRID_GROUP_ROLE, UM_DOMAIN WHERE "
                    + "UM_ROLE_ID=(SELECT UM_ID FROM UM_HYBRID_ROLE WHERE UPPER(UM_ROLE_NAME)=? AND UM_TENANT_ID=?) AND "
