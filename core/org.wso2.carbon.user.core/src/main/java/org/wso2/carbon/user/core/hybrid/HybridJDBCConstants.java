...
public class HybridJDBCConstants {
    ...
    public static final String GET_ROLES_PAGINATED_MSSQL = "SELECT UM_ROLE_NAME FROM UM_HYBRID_ROLE WHERE " +
            "UM_ROLE_NAME LIKE ? AND UM_TENANT_ID= ? ORDER BY UM_ROLE_NAME OFFSET ? ROW FETCH NEXT ? ROW ONLY";
    ...
    public static final String GET_INTERNAL_ROLES_PAGINATED_MSSQL = "SELECT UM_ROLE_NAME FROM UM_HYBRID_ROLE WHERE " +
            "UM_ROLE_NAME LIKE ? AND UM_TENANT_ID= ? AND NOT UM_ROLE_NAME LIKE ? ORDER BY UM_ROLE_NAME OFFSET ? ROW " +
            "FETCH NEXT ? ROW ONLY";
