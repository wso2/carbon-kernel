...
public final class JDBCRealmConstants {
    ...
    public static final String SELECT_USER_WITH_ID_SQL = "SELECT UM_USER.UM_USER_ID, UM_USER.UM_USER_PASSWORD, "
            + "UM_USER.UM_SALT_VALUE, UM_USER.UM_REQUIRE_CHANGE, UM_USER.UM_CHANGED_TIME FROM UM_USER, "
    ...
    public static final String GET_USER_FILTER_WITH_ID_SQL = "SELECT UM_USER.UM_USER_ID, UM_USER_ATTRIBUTE"
            + ".UM_ATTR_VALUE FROM UM_USER, UM_USER_ATTRIBUTE WHERE UM_USER_ATTRIBUTE.UM_USER_ID = UM_USER.UM_ID AND "
    ...
    public static final String GET_USERS_ROLE_WITH_ID_SQL = "SELECT UM_USER_ID,UM_ROLE_NAME FROM UM_USER_ROLE, "
    ...
    public static final String GET_USERS_IN_ROLE_FILTER_WITH_ID_SQL =
            "SELECT UM_USER.UM_USER_ID, UM_USER_ATTRIBUTE.UM_ATTR_VALUE FROM "
                    + "UM_USER_ROLE, UM_ROLE, UM_USER, UM_USER_ATTRIBUTE WHERE UM_USER_ATTRIBUTE.UM_ATTR_NAME=? AND "
                    + "UM_USER_ATTRIBUTE.UM_ATTR_VALUE LIKE ? AND UM_ROLE.UM_ROLE_NAME=? AND UM_USER.UM_ID=UM_USER_ROLE"
                    + ".UM_USER_ID AND UM_ROLE.UM_ID=UM_USER_ROLE.UM_ROLE_ID AND UM_USER.UM_ID=UM_USER_ATTRIBUTE"
                    + ".UM_USER_ID AND UM_USER_ROLE.UM_TENANT_ID=? AND UM_ROLE.UM_TENANT_ID=? AND UM_USER.UM_TENANT_ID=? AND "
                    + "UM_USER_ATTRIBUTE.UM_TENANT_ID=?";
    ...
    public static final String GET_USERS_IN_SHARED_ROLE_FILTER_SQL =
            "SELECT UM_USER_NAME FROM UM_SHARED_USER_ROLE INNER JOIN UM_USER ON "
                    ...
                    + "AND UM_SHARED_USER_ROLE.UM_USER_TENANT_ID = UM_USER.UM_TENANT_ID AND "
                    + "UM_SHARED_USER_ROLE.UM_ROLE_TENANT_ID = UM_ROLE.UM_TENANT_ID";
    public static final String GET_USERS_IN_SHARED_ROLE_FILTER_WITH_ID_SQL = "SELECT UM_USER.UM_USER_ID, "
            + "UM_USER_ATTRIBUTE.UM_ATTR_VALUE FROM UM_SHARED_USER_ROLE INNER JOIN UM_USER ON UM_SHARED_USER_ROLE"
            + ".UM_USER_ID = UM_USER.UM_ID INNER JOIN UM_ROLE ON UM_SHARED_USER_ROLE.UM_ROLE_ID = UM_ROLE.UM_ID INNER"
            + " JOIN UM_USER_ATTRIBUTE ON UM_USER_ATTRIBUTE.UM_USER_ID = UM_USER.UM_ID WHERE UM_USER_ATTRIBUTE"
            + ".UM_ATTR_NAME=? AND UM_USER_ATTRIBUTE.UM_ATTR_VALUE LIKE ? AND UM_ROLE.UM_ROLE_NAME= ? AND "
            + "UM_SHARED_USER_ROLE.UM_USER_TENANT_ID = UM_USER.UM_TENANT_ID AND UM_SHARED_USER_ROLE.UM_ROLE_TENANT_ID"
            + " = UM_ROLE.UM_TENANT_ID AND UM_USER_ATTRIBUTE.UM_TENANT_ID=UM_USER.UM_TENANT_ID";
    ...
    public static final String GET_IS_USER_EXISTING_WITH_ID_SQL = "SELECT UM_ID FROM UM_USER WHERE UM_USER_ID=? AND "
            + "UM_TENANT_ID=?";
    public static final String GET_IS_USER_NAME_EXISTING_SQL = "SELECT UM_ID FROM UM_USER_ATTRIBUTE WHERE "
            + "UM_ATTR_NAME=? AND UM_ATTR_VALUE=? AND UM_TENANT_ID=?";
    ...
    public static final String GET_USERS_PROPS_FOR_PROFILE_WITH_ID_SQL = "SELECT UM_USER_ID,UM_ATTR_NAME, "
            + "UM_ATTR_VALUE FROM UM_USER_ATTRIBUTE, UM_USER WHERE UM_USER.UM_ID = UM_USER_ATTRIBUTE.UM_USER_ID AND UM_USER" +
            ".UM_USER_ID IN (?) AND UM_PROFILE_ID=? AND UM_USER_ATTRIBUTE.UM_TENANT_ID=? AND UM_USER.UM_TENANT_ID=?";
    ...
    public static final String GET_USERS_FOR_PROP_WITH_ID_SQL = "SELECT DISTINCT UM_USER_ID FROM UM_USER, UM_USER_ATTRIBUTE " +
            "WHERE UM_USER_ATTRIBUTE.UM_USER_ID = UM_USER.UM_ID AND UM_USER_ATTRIBUTE.UM_ATTR_NAME =? " +
            "AND UM_USER_ATTRIBUTE.UM_ATTR_VALUE LIKE ? AND UM_USER_ATTRIBUTE.UM_PROFILE_ID=? " +
            "AND UM_USER_ATTRIBUTE.UM_TENANT_ID=? AND UM_USER.UM_TENANT_ID=?";
