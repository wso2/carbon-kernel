...
public final class JDBCRealmConstants {
    ...
    public static final String GET_USER_ID_FILTER_SQL = "SELECT U.UM_USER_NAME, UA.UM_ATTR_VALUE FROM UM_USER U, UM_USER_ATTRIBUTE UA "
            + "WHERE UA.UM_USER_ID = U.UM_ID AND UA.UM_ATTR_NAME =? AND UA.UM_ATTR_VALUE LIKE ? AND UA"
            + ".UM_PROFILE_ID=? AND UA.UM_TENANT_ID=? AND U.UM_TENANT_ID=?";
