...
public final class JDBCRealmConstants {
    ...
    public static final String ADD_USER_PROPERTY_UNICODE_SQL = "INSERT INTO UM_USER_ATTRIBUTE (UM_USER_ID, " +
            "UM_ATTR_NAME, UM_ATTR_VALUE, UM_ATTR_VALUE_UNICODE, UM_PROFILE_ID, UM_TENANT_ID) VALUES ((SELECT UM_ID " +
    ...
    public static final String ADD_USER_PROPERTY_WITH_ID_SQL = "INSERT INTO UM_USER_ATTRIBUTE (UM_USER_ID, "
            ...
            + "UM_USER_ID=? AND UM_TENANT_ID=?), ?, ?, ?, ?)";
    public static final String ADD_USER_PROPERTY_WITH_ID_UNICODE_SQL = "INSERT INTO UM_USER_ATTRIBUTE (UM_USER_ID, "
            + "UM_ATTR_NAME, UM_ATTR_VALUE, UM_ATTR_VALUE_UNICODE, UM_PROFILE_ID, UM_TENANT_ID) VALUES ((SELECT UM_ID" +
            " FROM UM_USER WHERE UM_USER_ID=? AND UM_TENANT_ID=?), ?, ?, ?, ?, ?)";
    ...
    public static final String UPDATE_USER_PROPERTY_UNICODE_SQL = "UPDATE UM_USER_ATTRIBUTE SET UM_ATTR_VALUE=?, "
            + "UM_ATTR_VALUE_UNICODE=? WHERE UM_USER_ID=(SELECT UM_ID FROM UM_USER WHERE UM_USER_NAME=? AND "
    ...
    public static final String UPDATE_USER_PROPERTY_WITH_ID_UNICODE_SQL = "UPDATE UM_USER_ATTRIBUTE SET UM_ATTR_VALUE=?, "
            + "UM_ATTR_VALUE_UNICODE=? WHERE UM_USER_ID=(SELECT UM_ID FROM UM_USER WHERE UM_USER_ID=? AND "
            + "UM_TENANT_ID=?) AND UM_ATTR_NAME=? AND UM_PROFILE_ID=? AND UM_TENANT_ID=?";
    public static final String UPDATE_USER_PROPERTY_WITH_ID_OPTIMIZED_SQL = "UPDATE UM_USER_ATTRIBUTE SET UM_ATTR_VALUE=? " +
            ...
            "UM_TENANT_ID=?) AND UM_TENANT_ID=?";
    public static final String UPDATE_USER_PROPERTY_UNICODE_WITH_ID_OPTIMIZED_SQL = "UPDATE UM_USER_ATTRIBUTE SET " +
            "UM_ATTR_VALUE=?, UM_ATTR_VALUE_UNICODE=? WHERE UM_ATTR_NAME=? AND UM_PROFILE_ID=? AND " +
            "UM_USER_ID=(SELECT UM_ID FROM UM_USER WHERE UM_USER_ID=? AND UM_TENANT_ID=?) AND UM_TENANT_ID=?";
    ...
    public static final String ADD_USER_PROPERTY_UNICODE_MSSQL_SQL = "INSERT INTO UM_USER_ATTRIBUTE (UM_USER_ID, " +
            "UM_ATTR_NAME, UM_ATTR_VALUE, UM_ATTR_VALUE_UNICODE, UM_PROFILE_ID, UM_TENANT_ID) SELECT (SELECT UM_ID FROM " +
