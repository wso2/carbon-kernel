...
public final class JDBCRealmConstants {
    ...
    public static final String GET_USER_FILTER_PAGINATED_WITH_USER_ID_SQL_MSSQL = "SELECT UM_USER_ID, UM_USER_NAME "
            + "FROM (SELECT UM_USER_ID, UM_USER_NAME, UM_TENANT_ID, ROW_NUMBER() OVER (ORDER BY UM_USER_NAME) AS "
            + "RowNum FROM UM_USER WHERE UM_USER_NAME LIKE ? AND UM_TENANT_ID=?) AS P WHERE P.RowNum BETWEEN ? AND ?";
    ...
    public static final String GET_PROPS_FOR_PROFILE_WITH_ID_SQL = "SELECT UA.UM_ATTR_NAME, UA.UM_ATTR_VALUE " +
            "FROM UM_USER_ATTRIBUTE UA JOIN UM_USER U ON U.UM_ID = UA.UM_USER_ID AND " +
            "U.UM_TENANT_ID = UA.UM_TENANT_ID WHERE U.UM_USER_ID = ? AND UA.UM_PROFILE_ID = ? " +
            "AND UA.UM_TENANT_ID = ? AND U.UM_TENANT_ID = ? ORDER BY UA.UM_ID ASC";
    ...
    public static final String GET_USERS_PROPS_FOR_PROFILE_WITH_ID_SQL = "SELECT U.UM_USER_ID, UA.UM_ATTR_NAME, " +
            "UA.UM_ATTR_VALUE FROM UM_USER_ATTRIBUTE UA JOIN UM_USER U ON U.UM_ID = UA.UM_USER_ID AND " +
            "U.UM_TENANT_ID = UA.UM_TENANT_ID WHERE U.UM_USER_ID IN (?) AND UA.UM_PROFILE_ID = ? " +
            "AND UA.UM_TENANT_ID = ? AND U.UM_TENANT_ID = ? ORDER BY UA.UM_ID ASC";
    ...
    public static final String SELECT_USER_PROPERTIES_WITH_ID_SQL = "SELECT UM_ID FROM UM_USER_ATTRIBUTE WITH " +
            ...
            "ORDER BY UM_ID;";
    public static final String SELECT_USER_PROPERTIES_WITH_ID_OPTIMIZED_SQL = "SELECT UM_ID FROM " +
            "UM_USER_ATTRIBUTE WITH (UPDLOCK) WHERE UM_USER_ID=(SELECT UM_ID FROM UM_USER WHERE UM_USER_ID=? AND " +
            "UM_TENANT_ID=?) AND UM_TENANT_ID=? ORDER BY UM_ID;";
    ...
    public static final String PROP_EXTENDED_ATTRIBUTE_VALUE_CHUNK_SIZE = "JDBCUserStore.ExtendedAttributes.ChunkSize";
    public static final String PROP_EXTENDED_ATTRIBUTE_VALUE_MAX_LENGTH = "JDBCUserStore.ExtendedAttributes.MaxLength";
