...
public final class JDBCRealmConstants {
    ...
    public static final String COUNT_USERS_WITH_CLAIM_SQL_HYBRID = "SELECT COUNT(UM_USER_ID) AS RESULT FROM " +
            "UM_USER_ATTRIBUTE WHERE UM_ATTR_NAME = ? AND UM_TENANT_ID = ? AND COALESCE(UM_ATTR_VALUE_UNICODE, " +
            "UM_ATTR_VALUE) LIKE ? AND UM_PROFILE_ID = ?";
    ...
    public static final String SELECT_USER_WITH_ID_SQL_HYBRID = "SELECT UM_USER.UM_USER_ID, UM_USER.UM_USER_NAME, " +
            "UM_USER.UM_USER_PASSWORD, UM_USER.UM_SALT_VALUE, UM_USER.UM_REQUIRE_CHANGE, UM_USER.UM_CHANGED_TIME FROM " +
            "UM_USER, UM_USER_ATTRIBUTE WHERE UM_USER_ATTRIBUTE.UM_USER_ID = UM_USER.UM_ID AND UM_USER_ATTRIBUTE" +
            ".UM_ATTR_NAME =? AND COALESCE(UM_USER_ATTRIBUTE.UM_ATTR_VALUE_UNICODE, UM_USER_ATTRIBUTE.UM_ATTR_VALUE) =?" +
    ...
    public static final String GET_PROPS_FOR_PROFILE_SQL_HYBRID = "SELECT UM_ATTR_NAME, COALESCE(UM_ATTR_VALUE_UNICODE, " +
            "UM_ATTR_VALUE) FROM UM_USER_ATTRIBUTE, UM_USER WHERE UM_USER.UM_ID = UM_USER_ATTRIBUTE.UM_USER_ID AND " +
            "UM_USER.UM_USER_NAME=? AND UM_PROFILE_ID=? AND UM_USER_ATTRIBUTE.UM_TENANT_ID=? AND UM_USER.UM_TENANT_ID=?";
    ...
    public static final String GET_PROPS_FOR_PROFILE_WITH_ID_SQL_HYBRID = "SELECT UM_ATTR_NAME, " +
            "COALESCE(UM_ATTR_VALUE_UNICODE, UM_ATTR_VALUE) FROM UM_USER_ATTRIBUTE, UM_USER WHERE UM_USER" +
            ".UM_ID = UM_USER_ATTRIBUTE.UM_USER_ID AND UM_USER.UM_USER_ID=? AND UM_PROFILE_ID=? AND UM_USER_ATTRIBUTE" +
            ".UM_TENANT_ID=? AND UM_USER.UM_TENANT_ID=?";
    ...
    public static final String GET_USERS_PROPS_FOR_PROFILE_SQL_HYBRID = "SELECT UM_USER.UM_USER_ID, UM_ATTR_NAME, " +
            "COALESCE(UM_ATTR_VALUE_UNICODE, UM_ATTR_VALUE) FROM UM_USER_ATTRIBUTE, UM_USER WHERE UM_USER.UM_ID = " +
            "UM_USER_ATTRIBUTE.UM_USER_ID AND UM_USER.UM_USER_NAME IN (?) AND UM_PROFILE_ID=? AND UM_USER_ATTRIBUTE" +
            ".UM_TENANT_ID=? AND UM_USER.UM_TENANT_ID=?";
    public static final String GET_USERS_PROPS_FOR_PROFILE_WITH_ID_SQL = "SELECT UM_USER.UM_USER_ID, UM_ATTR_NAME, "
            ...
            + ".UM_TENANT_ID=?";
    public static final String GET_USERS_PROPS_FOR_PROFILE_WITH_ID_SQL_HYBRID = "SELECT UM_USER.UM_USER_ID, " +
            "UM_ATTR_NAME, COALESCE(UM_ATTR_VALUE_UNICODE, UM_ATTR_VALUE) FROM UM_USER_ATTRIBUTE, UM_USER WHERE " +
            "UM_USER.UM_ID = UM_USER_ATTRIBUTE.UM_USER_ID AND UM_USER.UM_USER_ID IN (?) AND UM_PROFILE_ID=? AND " +
            "UM_USER_ATTRIBUTE.UM_TENANT_ID=? AND UM_USER.UM_TENANT_ID=?";
    ...
    public static final String GET_PROP_FOR_PROFILE_SQL_HYBRID = "SELECT COALESCE(UM_ATTR_VALUE_UNICODE, UM_ATTR_VALUE) " +
            "FROM UM_USER_ATTRIBUTE, UM_USER WHERE UM_USER.UM_ID = UM_USER_ATTRIBUTE.UM_USER_ID AND UM_USER" +
            ".UM_USER_NAME=? AND UM_ATTR_NAME=? AND UM_PROFILE_ID=? AND UM_USER_ATTRIBUTE.UM_TENANT_ID=? AND UM_USER" +
            ".UM_TENANT_ID=?";
    public static final String GET_PROP_FOR_PROFILE_WITH_ID_SQL = "SELECT UM_ATTR_VALUE FROM UM_USER_ATTRIBUTE, "
            ...
            + " AND UM_PROFILE_ID=? AND UM_USER_ATTRIBUTE.UM_TENANT_ID=? AND UM_USER.UM_TENANT_ID=?";
    public static final String GET_PROP_FOR_PROFILE_WITH_ID_SQL_HYBRID = "SELECT COALESCE(UM_ATTR_VALUE_UNICODE, " +
            "UM_ATTR_VALUE) FROM UM_USER_ATTRIBUTE, UM_USER WHERE UM_USER.UM_ID = UM_USER_ATTRIBUTE.UM_USER_ID AND " +
            "UM_USER.UM_USER_ID=? AND UM_ATTR_NAME=? AND UM_PROFILE_ID=? AND UM_USER_ATTRIBUTE.UM_TENANT_ID=? AND " +
            "UM_USER.UM_TENANT_ID=?";
    ...
    public static final String GET_USERS_FOR_PROP_SQL_HYBRID = "SELECT DISTINCT UM_USER_NAME FROM UM_USER, " +
            "UM_USER_ATTRIBUTE WHERE UM_USER_ATTRIBUTE.UM_USER_ID = UM_USER.UM_ID AND UM_USER_ATTRIBUTE.UM_ATTR_NAME =? " +
            "AND COALESCE(UM_USER_ATTRIBUTE.UM_ATTR_VALUE_UNICODE, UM_USER_ATTRIBUTE.UM_ATTR_VALUE) LIKE ? " +
            "AND UM_USER_ATTRIBUTE.UM_PROFILE_ID=? AND UM_USER_ATTRIBUTE.UM_TENANT_ID=? AND UM_USER.UM_TENANT_ID=?";
    public static final String GET_USERS_FOR_PROP_SQL_WITH_ESCAPE = "SELECT DISTINCT UM_USER_NAME FROM UM_USER, " +
            ...
            "AND UM_USER_ATTRIBUTE.UM_TENANT_ID=? AND UM_USER.UM_TENANT_ID=?";
    public static final String GET_USERS_FOR_PROP_SQL_WITH_ESCAPE_HYBRID = "SELECT DISTINCT UM_USER_NAME FROM UM_USER, " +
            " UM_USER_ATTRIBUTE WHERE UM_USER_ATTRIBUTE.UM_USER_ID = UM_USER.UM_ID AND UM_USER_ATTRIBUTE.UM_ATTR_NAME =? " +
            "AND COALESCE(UM_USER_ATTRIBUTE.UM_ATTR_VALUE_UNICODE, UM_USER_ATTRIBUTE.UM_ATTR_VALUE) LIKE ? ESCAPE ? " +
            "AND UM_USER_ATTRIBUTE.UM_PROFILE_ID=? AND UM_USER_ATTRIBUTE.UM_TENANT_ID=? AND UM_USER.UM_TENANT_ID=?";
    public static final String GET_USERS_FOR_CLAIM_VALUE_SQL = "SELECT DISTINCT UM_USER_NAME FROM UM_USER, " +
            ...
            "AND UM_USER_ATTRIBUTE.UM_TENANT_ID=? AND UM_USER.UM_TENANT_ID=?";
    public static final String GET_USERS_FOR_CLAIM_VALUE_SQL_HYBRID = "SELECT DISTINCT UM_USER_NAME FROM UM_USER, " +
            " UM_USER_ATTRIBUTE WHERE UM_USER_ATTRIBUTE.UM_USER_ID = UM_USER.UM_ID AND UM_USER_ATTRIBUTE.UM_ATTR_NAME =? " +
            "AND COALESCE(UM_USER_ATTRIBUTE.UM_ATTR_VALUE_UNICODE, UM_USER_ATTRIBUTE.UM_ATTR_VALUE) =? AND " +
    ...
    public static final String GET_USERS_FOR_PROP_WITH_ID_SQL = "SELECT DISTINCT UM_USER.UM_USER_ID FROM UM_USER, "
            ...
            "AND UM_USER_ATTRIBUTE.UM_ATTR_VALUE LIKE ? AND UM_USER_ATTRIBUTE.UM_PROFILE_ID=? " +
            "AND UM_USER_ATTRIBUTE.UM_TENANT_ID=? AND UM_USER.UM_TENANT_ID=?";
    public static final String GET_USERS_FOR_PROP_WITH_ID_SQL_HYBRID = "SELECT DISTINCT UM_USER.UM_USER_ID FROM UM_USER, "
            + "UM_USER_ATTRIBUTE WHERE UM_USER_ATTRIBUTE.UM_USER_ID = UM_USER.UM_ID AND UM_USER_ATTRIBUTE.UM_ATTR_NAME =? " +
            "AND COALESCE(UM_USER_ATTRIBUTE.UM_ATTR_VALUE_UNICODE, UM_USER_ATTRIBUTE.UM_ATTR_VALUE) LIKE ? AND " +
            "UM_USER_ATTRIBUTE.UM_PROFILE_ID=? AND UM_USER_ATTRIBUTE.UM_TENANT_ID=? AND UM_USER.UM_TENANT_ID=?";
    ...
    public static final String GET_USERS_FOR_CLAIM_VALUE_WITH_ID_SQL = "SELECT DISTINCT UM_USER.UM_USER_ID FROM " +
            ...
            "UM_USER_ATTRIBUTE.UM_PROFILE_ID=? AND UM_USER_ATTRIBUTE.UM_TENANT_ID=? AND UM_USER.UM_TENANT_ID=?";
    public static final String GET_USERS_FOR_CLAIM_VALUE_WITH_ID_SQL_HYBRID = "SELECT DISTINCT UM_USER.UM_USER_ID FROM " +
            " UM_USER, UM_USER_ATTRIBUTE WHERE UM_USER_ATTRIBUTE.UM_USER_ID = UM_USER.UM_ID AND " +
            "UM_USER_ATTRIBUTE.UM_ATTR_NAME =? AND COALESCE(UM_USER_ATTRIBUTE.UM_ATTR_VALUE_UNICODE, " +
    ...
    public static final String GET_PAGINATED_USERS_FOR_PROP_SQL_HYBRID = "SELECT UM_USER_NAME FROM UM_USER, "
            + "UM_USER_ATTRIBUTE WHERE UM_USER_ATTRIBUTE.UM_USER_ID = UM_USER.UM_ID AND UM_USER_ATTRIBUTE.UM_ATTR_NAME "
            + "=? AND COALESCE(UM_USER_ATTRIBUTE.UM_ATTR_VALUE_UNICODE, UM_USER_ATTRIBUTE.UM_ATTR_VALUE) LIKE ? AND "
            + "UM_USER_ATTRIBUTE.UM_PROFILE_ID=? AND UM_USER_ATTRIBUTE.UM_TENANT_ID=? AND UM_USER.UM_TENANT_ID=? ORDER BY "
            + "UM_USER_NAME ASC LIMIT ? OFFSET";
    public static final String GET_PAGINATED_USERS_FOR_PROP_WITH_ID_SQL = "SELECT UM_USER.UM_USER_ID, UM_USER"
            ...
            + " ASC LIMIT ? OFFSET ?";
    public static final String GET_PAGINATED_USERS_FOR_PROP_WITH_ID_SQL_HYBRID = "SELECT UM_USER.UM_USER_ID, "
            + "UM_USER.UM_USER_NAME FROM UM_USER, UM_USER_ATTRIBUTE WHERE UM_USER_ATTRIBUTE.UM_USER_ID = UM_USER.UM_ID "
            + "AND UM_USER_ATTRIBUTE.UM_ATTR_NAME =? AND COALESCE(UM_USER_ATTRIBUTE.UM_ATTR_VALUE_UNICODE, "
            + "UM_USER_ATTRIBUTE.UM_ATTR_VALUE) LIKE ? AND UM_USER_ATTRIBUTE.UM_PROFILE_ID=? AND "
            + "UM_USER_ATTRIBUTE.UM_TENANT_ID=? AND UM_USER.UM_TENANT_ID=? ORDER BY UM_USER_NAME ASC LIMIT ? OFFSET ?";
    ...
    public static final String GET_PAGINATED_USERS_COUNT_FOR_PROP_SQL_HYBRID = "SELECT COUNT (UM_USER_NAME) FROM UM_USER, "
            + "UM_USER_ATTRIBUTE WHERE UM_USER_ATTRIBUTE.UM_USER_ID = UM_USER.UM_ID AND UM_USER_ATTRIBUTE.UM_ATTR_NAME "
            + "=? AND COALESCE(UM_USER_ATTRIBUTE.UM_ATTR_VALUE_UNICODE, UM_USER_ATTRIBUTE.UM_ATTR_VALUE) LIKE ? AND "
            + "UM_USER_ATTRIBUTE.UM_PROFILE_ID=? AND UM_USER_ATTRIBUTE.UM_TENANT_ID=? AND UM_USER.UM_TENANT_ID=?";
    public static final String GET_PAGINATED_USERS_COUNT_FOR_PROP_WITH_ID_SQL = "SELECT COUNT (UM_USER.UM_USER_ID) "
            ...
            "=? AND UM_USER_ATTRIBUTE.UM_ATTR_VALUE LIKE ? AND UM_USER_ATTRIBUTE.UM_PROFILE_ID=? AND UM_USER_ATTRIBUTE.UM_TENANT_ID=? AND UM_USER.UM_TENANT_ID=?";
    public static final String GET_PAGINATED_USERS_COUNT_FOR_PROP_WITH_ID_SQL_HYBRID = "SELECT COUNT (UM_USER.UM_USER_ID) "
            + "FROM UM_USER, UM_USER_ATTRIBUTE WHERE UM_USER_ATTRIBUTE.UM_USER_ID = UM_USER.UM_ID AND UM_USER_ATTRIBUTE.UM_ATTR_NAME "
            + "=? AND COALESCE(UM_USER_ATTRIBUTE.UM_ATTR_VALUE_UNICODE, UM_USER_ATTRIBUTE.UM_ATTR_VALUE) LIKE ? AND "
            + "UM_USER_ATTRIBUTE.UM_PROFILE_ID=? AND UM_USER_ATTRIBUTE.UM_TENANT_ID=? AND UM_USER.UM_TENANT_ID=?";
    ...
    public static final String USER_NAME_UNIQUE_SQL_WITH_ID_HYBRID = "SELECT UM_ID FROM UM_USER_ATTRIBUTE WHERE "
            + "UM_ATTR_NAME=? AND COALESCE(UM_ATTR_VALUE_UNICODE, UM_ATTR_VALUE)=?";
