...
CREATE TABLE IF NOT EXISTS UM_DOMAIN(
            UM_DOMAIN_ID INTEGER NOT NULL AUTO_INCREMENT UNIQUE,
            UM_DOMAIN_NAME VARCHAR(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS UM_UUID_DOMAIN_MAPPER (
            ...
            PRIMARY KEY (UM_ID),
            UNIQUE (UM_USER_ID),
            FOREIGN KEY (UM_DOMAIN_ID) REFERENCES UM_DOMAIN(UM_DOMAIN_ID)
);

CREATE INDEX IF NOT EXISTS UUID_DM_UID ON UM_UUID_DOMAIN_MAPPER(UM_USER_ID);
