...
public class JDBCPathCache extends PathCache {
    ...
    /**
     * Method to add resource path entry to the database using Managed registry Connection.
     *
     * @param conn         the Managed registry Connection.
     * @param path         the path to add.
     * @param parentPathId the parent path's id.
     *
     * @return the path's id.
     ...
     * @throws SQLException      if an error occurs while adding the entry.
     */
    public int addEntry(JDBCDatabaseTransaction.ManagedRegistryConnection conn,
                        String path, int parentPathId) throws SQLException, RegistryException {
        ResultSet results = null;
        PreparedStatement ps = null;
        PreparedStatement ps1 = null;
        DataAccessManager dataAccessManager;
