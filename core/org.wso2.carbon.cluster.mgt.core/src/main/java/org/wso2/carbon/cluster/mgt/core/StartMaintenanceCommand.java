...
/**
 *  Cluster management command for starting maintenance on this node. 
 */
public class StartMaintenanceCommand extends GroupManagementCommand {
    
    private static final Log log = LogFactory.getLog(StartMaintenanceCommand.class);
    ...
    public void execute(ConfigurationContext configurationContext) throws ClusteringFault {
        ...
        try {
            new ServerManagement(inTransports, configurationContext).startMaintenance();
        } catch (Exception e) {
            String msg = "Cannot start maintenance";
            log.error(msg, e);
        }
    }
}
