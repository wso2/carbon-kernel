 ...
 *
 */
public class ShutdownMemberGracefullyCommand extends GroupManagementCommand {
    private static final Log log = LogFactory.getLog(ShutdownMemberGracefullyCommand.class);
