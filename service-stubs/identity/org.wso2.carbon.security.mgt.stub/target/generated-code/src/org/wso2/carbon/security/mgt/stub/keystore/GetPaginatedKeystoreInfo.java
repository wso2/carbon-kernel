 ...
 */
            ...
            /**
            *  GetPaginatedKeystoreInfo bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetPaginatedKeystoreInfo
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getPaginatedKeystoreInfo",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getPaginatedKeystoreInfo",
    ...
    public static class Factory{
        ...
        */
        public static GetPaginatedKeystoreInfo parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetPaginatedKeystoreInfo object =
                new GetPaginatedKeystoreInfo();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getPaginatedKeystoreInfo".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetPaginatedKeystoreInfo)org.wso2.carbon.security.mgt.stub.keystore.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://service.keystore.security.carbon.wso2.org","pageNumber").equals(reader.getName())){
