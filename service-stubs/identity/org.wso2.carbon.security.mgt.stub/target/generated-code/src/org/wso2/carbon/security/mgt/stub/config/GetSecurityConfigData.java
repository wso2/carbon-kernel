 ...
 */
            ...
            /**
            *  GetSecurityConfigData bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetSecurityConfigData
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns3");
                        ...
                        */
                        ...
                        /**
                        * field for ScenarioId
                        */

                        
                                    protected java.lang.String localScenarioId ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localScenarioIdTracker = false ;

                           public boolean isScenarioIdSpecified(){
                               return localScenarioIdTracker;
                           }
                           ...
                           */
                           public  java.lang.String getScenarioId(){
                            ...
                            /**
                               * Auto generated setter method
                               * @param param ScenarioId
                               */
                               public void setScenarioId(java.lang.String param){
                            localScenarioIdTracker = true;
                                   
                                            this.localScenarioId=param;
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getSecurityConfigData",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getSecurityConfigData",
                ...
                if (localServiceNameTracker){
                             ...
                             } if (localScenarioIdTracker){
                                    namespace = "http://service.config.security.carbon.wso2.org";
                                    writeStartElement(null, namespace, "scenarioId", xmlWriter);
                             

                                          if (localScenarioId==null){
                                              // write the nil attribute
                                                   ...
                                                   xmlWriter.writeCharacters(localScenarioId);
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localServiceNameTracker){
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://service.config.security.carbon.wso2.org",
                                         ...
                                         elementList.add(localScenarioId==null?null:
                                         org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localScenarioId));
                                    } if (localPolicyPathTracker){
                                      elementList.add(new javax.xml.namespace.QName("http://service.config.security.carbon.wso2.org",
                                                                      "policyPath"));
    ...
    public static class Factory{
        ...
        */
        public static GetSecurityConfigData parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetSecurityConfigData object =
                new GetSecurityConfigData();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getSecurityConfigData".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetSecurityConfigData)org.wso2.carbon.security.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://service.config.security.carbon.wso2.org","scenarioId").equals(reader.getName())){
