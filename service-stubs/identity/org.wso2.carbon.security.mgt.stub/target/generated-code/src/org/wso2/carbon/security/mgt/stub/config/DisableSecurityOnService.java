 ...
 */
            ...
            /**
            *  DisableSecurityOnService bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class DisableSecurityOnService
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":disableSecurityOnService",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "disableSecurityOnService",
    ...
    public static class Factory{
        ...
        */
        public static DisableSecurityOnService parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DisableSecurityOnService object =
                new DisableSecurityOnService();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"disableSecurityOnService".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (DisableSecurityOnService)org.wso2.carbon.security.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
