 ...
 */
            ...
            /**
            *  ImportCertToStore bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ImportCertToStore
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":importCertToStore",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "importCertToStore",
                ...
                if (localFileNameTracker){
                                    namespace = "http://service.keystore.security.carbon.wso2.org";
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localFileNameTracker){
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://service.keystore.security.carbon.wso2.org",
                                         ...
                                         elementList.add(localFileData==null?null:
                                         org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localFileData));
                                    } if (localKeyStoreNameTracker){
                                      elementList.add(new javax.xml.namespace.QName("http://service.keystore.security.carbon.wso2.org",
                                                                      "keyStoreName"));
    ...
    public static class Factory{
        ...
        */
        public static ImportCertToStore parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ImportCertToStore object =
                new ImportCertToStore();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"importCertToStore".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ImportCertToStore)org.wso2.carbon.security.mgt.stub.keystore.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://service.keystore.security.carbon.wso2.org","fileName").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://service.keystore.security.carbon.wso2.org","fileData").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://service.keystore.security.carbon.wso2.org","keyStoreName").equals(reader.getName())){
