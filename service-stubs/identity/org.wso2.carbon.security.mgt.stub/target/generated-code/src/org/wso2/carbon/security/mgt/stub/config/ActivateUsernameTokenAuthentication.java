...
/**
 * ActivateUsernameTokenAuthentication.java
 *
 ...
 */
            ...
            /**
            *  ActivateUsernameTokenAuthentication bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ActivateUsernameTokenAuthentication
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":activateUsernameTokenAuthentication",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "activateUsernameTokenAuthentication",
                ...
                if (localServiceNameTracker){
                             ...
                             if (localUserGroups!=null) {
                                   ...
                                   for (int i = 0;i < localUserGroups.length;i++){
                                        ...
                                        // write null attribute
                                           writeStartElement(null, "http://service.config.security.carbon.wso2.org", "userGroups", xmlWriter);
    ...
    public static class Factory{
        ...
        */
        public static ActivateUsernameTokenAuthentication parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ActivateUsernameTokenAuthentication object =
                new ActivateUsernameTokenAuthentication();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"activateUsernameTokenAuthentication".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ActivateUsernameTokenAuthentication)org.wso2.carbon.security.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list2 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://service.config.security.carbon.wso2.org","userGroups").equals(reader.getName())){
                                    ...
                                    // Process the array and step past its final element's end.
                                            ...
                                            while(!loopDone2){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("http://service.config.security.carbon.wso2.org","userGroups").equals(reader.getName())){
