...
public class WKAMembershipSchemeTestCase extends BaseTest {
    ...
    public void setup() throws ClusterConfigurationException {
        String clusterXMLLocation1 = getTestResourceFile("cluster-03.xml").getAbsolutePath();
        ...
        String clusterXMLLocation2 = getTestResourceFile("cluster-04.xml").getAbsolutePath();
