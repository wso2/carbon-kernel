...
public class AuthorizationCache {
	 ...
	 * 
	 * @param serverId
	 *            unique identifier for carbon server instance
	 * @param userName
	 *            Name of the user which was authorized. If this is null
	 *            roleName must not be null.
	 * @param resourceId
	 *            The resource on which user/role was authorized.
	 * @param action
	 *            The action which user/role authorized for.
	 * @param isAuthorized
	 *            Whether role/user was authorized or not. <code>true</code> for
	 ...
	 *            tenant id
	 * @param userName
	 *            User name. Both user name and role name cannot be null at the
	 *            same time.
	 * @param resourceId
	 *            The resource which we need to check.
	 * @param action
	 *            The action on resource.
	 * @return <code>true</code> if an entry is found in cache and user/role is
	 *         authorized. else <code>false</code>.
	 * @throws AuthorizationCacheException
	 *             an entry is not found in the cache.
	 */
	 ...
	 *            tenant id
	 * @param userName
	 *            User name to construct the cache key.
	 * @param resourceId
	 *            Resource id to construct the cache key.
	 * @param action
	 *            Action to construct the cache key.
	 */
