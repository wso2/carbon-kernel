...
/**
 * Represents the internal Cache Entry Value with in an {@link CarbonCache}.
 * <p>
 * The actual value passed to the Cache is represented in an internal format,
 * generated by passing the value through an {@link InternalConverter}.
 * </p>
 * {@link CarbonCachedValue}s additionally store and provide meta information about
 * Cache Entry Values, including information for dealing with expiry.
 */
public class CarbonCachedValue {

  /**
   * The internal representation of the Cache Entry value.
   *
   * @see InternalConverter
   */
  ...
  /**
   * Constructs an {@link CarbonCachedValue} with the creation, access and
   ...
   */
  public CarbonCachedValue(Object internalValue, long creationTime, long expiryTime) {
