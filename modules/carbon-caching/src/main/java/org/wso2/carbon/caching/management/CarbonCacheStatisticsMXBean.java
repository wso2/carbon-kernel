 ...
 */
package org.wso2.carbon.caching.management;

import org.wso2.carbon.caching.CarbonCache;
...
public class CarbonCacheStatisticsMXBean implements CacheStatisticsMXBean, Serializable {
   ...
   */
  public CarbonCacheStatisticsMXBean(Cache<?, ?> cache) {
    this.cache = cache;
  }
  ...
  public long getEntryCount() {
    return ((CarbonCache<?, ?>) cache).getSize();
  }
