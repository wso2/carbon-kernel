...
public class TestContext implements Context {
    ...
    private String contextFactoryBuilderClassName;

    private Hashtable<String, Object> environment;

    public TestContext(Hashtable<String, Object> environment) throws NamingException {
    ...
    public void setContextFactoryClass(String contextFactoryClass) {
        this.contextFactoryClassName = contextFactoryClass;
    }

    public String getContextFactoryBuilderClass() {
        return contextFactoryBuilderClassName;
    }

    public void setContextFactoryBuilderClass(String contextFactoryBuilderClass) {
        this.contextFactoryBuilderClassName = contextFactoryBuilderClass;
    }
