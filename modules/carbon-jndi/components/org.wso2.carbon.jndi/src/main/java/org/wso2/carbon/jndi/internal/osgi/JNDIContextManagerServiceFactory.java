...
public class JNDIContextManagerServiceFactory implements ServiceFactory<JNDIContextManager> {
    ...
    @Override
    public JNDIContextManager getService(Bundle bundle, ServiceRegistration<JNDIContextManager> serviceRegistration) {
        return new JNDIContextManagerImpl(bundle.getBundleContext(), serviceRegistration);
    }
