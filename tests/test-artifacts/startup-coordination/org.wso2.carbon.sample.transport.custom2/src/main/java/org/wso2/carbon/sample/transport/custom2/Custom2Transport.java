 ...
 */
package org.wso2.carbon.sample.transport.custom2;
 ...
 * @since 5.0.0
 */
public class Custom2Transport implements Transport {
    private static final Logger logger = LoggerFactory.getLogger(Custom2Transport.class);
