...
public class OSGiTestConfigurationUtils {
     ...
     */
    private static List<Option> getBaseOptions(String carbonHome, String serverKey, String serverName,
        ...
        if (System.getProperty(Constants.PAX_EXAM_SYSTEM, Constants.PAX_EXAM_SYSTEM_TEST)
                .equals(Constants.PAX_EXAM_SYSTEM_DEFAULT)) {
        ...
        optionList.add(mavenBundle().artifactId("org.eclipse.osgi.services").groupId("org.wso2.eclipse.osgi")
                .versionAsInProject());
        optionList
                .add(mavenBundle().artifactId("pax-logging-api").groupId("org.ops4j.pax.logging").versionAsInProject());
        ...
        optionList.add(mavenBundle().artifactId("org.eclipse.equinox.ds").groupId("org.wso2.eclipse.equinox")
                .versionAsInProject());
        optionList
                .add(mavenBundle().artifactId("org.eclipse.equinox.frameworkadmin").groupId("org.wso2.eclipse.equinox")
                        .versionAsInProject());
        ...
        optionList.add(mavenBundle().artifactId("org.eclipse.equinox.cm").groupId("org.wso2.eclipse.equinox")
                .versionAsInProject());
        optionList.add(mavenBundle().artifactId("snakeyaml").groupId("org.wso2.orbit.org.yaml").versionAsInProject());
        optionList
                .add(mavenBundle().artifactId("org.wso2.carbon.core").groupId("org.wso2.carbon").versionAsInProject());
