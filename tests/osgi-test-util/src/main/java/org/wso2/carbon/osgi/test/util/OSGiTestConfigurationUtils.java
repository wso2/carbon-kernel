...
//        optionList.add(CarbonDistributionConfiguration().distributionZipURL(Paths.get(
//                "/home/chanaka/Documents/WSO2/Git/C5/C5-2/carbon-kernel/tests/distribution-test/target/wso2carbon-kernel-test-5.1.0-SNAPSHOT.zip"))
//                .unpackDirectory(Paths.get(System.getProperty("carbon.home"))));
