...
public class CustomRuntimeOSGiTest {
    ...
    public Option[] createConfiguration() {
        ...
        optionList.add(carbonDropinsBundle(maven().artifactId("org.wso2.carbon.sample.runtime.mgt").groupId("org.wso2"
                + ".carbon")
                .versionAsInProject()));
        optionList.add(carbonDropinsBundle(maven().artifactId("org.wso2.carbon.sample.runtime.mss").groupId("org.wso2"
                + ".carbon")
                .versionAsInProject()));
