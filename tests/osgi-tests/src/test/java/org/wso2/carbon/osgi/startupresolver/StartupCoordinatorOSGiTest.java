...
public class StartupCoordinatorOSGiTest {
    ...
    public Option[] createConfiguration() {
        ...
        optionList.add(carbonDropinsBundle(maven().artifactId("org.wso2.carbon.sample.runtime.mss").groupId("org.wso2.carbon")
                .versionAsInProject()));
        optionList.add(carbonDropinsBundle(maven().artifactId("org.wso2.carbon.sample.runtime.jar").groupId("org.wso2.carbon")
                .versionAsInProject()));
        optionList.add(carbonDropinsBundle(maven().artifactId("org.wso2.carbon.sample.runtime.bps").groupId("org.wso2.carbon")
                .versionAsInProject()));
        optionList.add(carbonDropinsBundle(maven().artifactId("org.wso2.carbon.sample.runtime.webapp").groupId("org.wso2.carbon")
                .versionAsInProject()));
        optionList.add(carbonDropinsBundle(maven().artifactId("org.wso2.carbon.sample.runtime.custom").groupId("org.wso2.carbon")
                .versionAsInProject()));
