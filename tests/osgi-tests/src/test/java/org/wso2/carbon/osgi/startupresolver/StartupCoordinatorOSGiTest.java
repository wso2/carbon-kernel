    ...
    public Option[] createConfiguration() {
        return new Option[] { copyDropinsBundle(
                ...
                maven().artifactId("org.wso2.carbon.sample.runtime.mss").groupId("org.wso2.carbon")
                        .versionAsInProject()), copyDropinsBundle(
                maven().artifactId("org.wso2.carbon.sample.runtime.jar").groupId("org.wso2.carbon")
                        .versionAsInProject()), copyDropinsBundle(
                maven().artifactId("org.wso2.carbon.sample.runtime.bps").groupId("org.wso2.carbon")
                        .versionAsInProject()), copyDropinsBundle(
                maven().artifactId("org.wso2.carbon.sample.runtime.webapp").groupId("org.wso2.carbon")
                        .versionAsInProject()), copyDropinsBundle(
                maven().artifactId("org.wso2.carbon.sample.runtime.custom").groupId("org.wso2.carbon")
                        .versionAsInProject()), copyDropinsBundle(
