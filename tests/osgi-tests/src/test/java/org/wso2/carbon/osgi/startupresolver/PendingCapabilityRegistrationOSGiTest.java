...
public class PendingCapabilityRegistrationOSGiTest {
    ...
    public Option[] createConfiguration() {
        ...
        optionList.add(mavenBundle().artifactId("org.wso2.carbon.sample.transport.http").groupId("org.wso2.carbon")
                .versionAsInProject());
        optionList.add(mavenBundle().artifactId("org.wso2.carbon.sample.transport.jetty").groupId("org.wso2.carbon")
                .versionAsInProject());
        optionList.add(mavenBundle().artifactId("org.wso2.carbon.sample.transport.custom2").groupId("org.wso2" +
                ".carbon").versionAsInProject());
        optionList.add(mavenBundle().artifactId("org.wso2.carbon.sample.datasource.mgt").groupId("org.wso2.carbon")
                .versionAsInProject());
