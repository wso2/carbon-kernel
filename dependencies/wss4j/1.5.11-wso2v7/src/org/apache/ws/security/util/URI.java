...
public class URI implements Serializable {
	...
	public static class MalformedURIException extends IOException {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -6066218134180631010L;
	...
	private void initialize(URI p_base, String p_uriSpec) throws MalformedURIException {
		...
		if (colonIndex < 0) {
			...
			// a) If <uriSpec> starts with a slash (/), it means <uriSpec>
			// is absolute
			...
			//
			if (m_scheme != null && p_base != null && uriSpec.startsWith("/")
		...
		if (p_userinfo == null) {
			...
			while (index < end) {
				...
				if (testChar == '%') {
					...
					throw new MalformedURIException("Userinfo contains invalid character:"
							+ testChar);
				}
