...
for h in "$CARBON_HOME"/osgi/plugins/*.jar
do
...
java -cp "../bin/bootstrap/tools/*:../bin/bootstrap/*" -Dwso2.carbon.tool="cipher-tool" org.wso2.carbon.tools.CarbonToolExecutor "$1" "$CARBON_HOME"