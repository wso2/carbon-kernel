 ...
 */
package org.wso2.carbon.configuration.component.processor;
 ...
 * @since 5.2.0
 */
@SupportedAnnotationTypes("org.wso2.carbon.configuration.component.annotation.Configuration")
...
public class ConfigurationProcessor extends AbstractProcessor {
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        ...
        for (Element element : configSet) {
            ...
            if (configuration != null && !Constants.NULL.equals(configuration.namespace())) {
        ...
        if (builder.length() > 0) {
            try {
                FileObject file = processingEnv.getFiler().createResource(StandardLocation.CLASS_OUTPUT, "",
                        Constants.TEMP_CONFIG_FILE_NAME);
